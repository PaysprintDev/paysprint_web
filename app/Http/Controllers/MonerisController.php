...
=======
>>>>>>> 1965ed06d1b07d1b3290923ef3a1ba9eff037bc9
        ...
        if (isset($req->mode) && $req->mode == "test") {
            ...
            if ($validator->passes()) {
                ...
                if ($req->paymentToken != null) {
                    ...
                    $this->updatePoints($thisuser->accountType, $thisuser->id, 'Add money');
                            ...
                            if ($billPayResponse->responseCode == 00 || $billPayResponse->responseCode == 0) {
                                ...
                                if (isset($billPayResponse->status) && $billPayResponse->status == 400) {
                                    ...
                                    if (isset($billPayResponse)) {
                                        ...
                                        $this->updatePoints($thisuser->accountType, $thisuser->id, 'Pay bills');
