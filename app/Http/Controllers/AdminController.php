...
class AdminController extends Controller
{
    ...
    public function allPsMerchants(Request $req)
    {
        if ($req->session()->has('username') == true) {
            // dd(Session::all());
    ...
    public function paysprintFxReport(Request $req)
    {
        ...
        if ($req->session()->has('username') == true) {
            ...
            $data = [
                'statement' => $this->getTransactionStatementByCountry($req->month)
            ];


            return view('admin.report.psfxreport')->with(['pages' => 'Dashboard', 'clientPay' => $clientPay, 'adminUser' => $adminUser, 'invoiceImport' => $invoiceImport, 'payInvoice' => $payInvoice, 'otherPays' => $otherPays, 'transCost' => $transCost, 'data' => $data]);
        } else {
            return redirect()->route('AdminLogin');
        }
    }
    ...
    public function paysprintFxReportByCountry(Request $req)
    {
        ...
        if ($req->session()->has('username') == true) {
            ...
            $data = [
                'statement' => $this->getSpecificTransactionStatementByCountry($req->country, $req->month)
            ];


            return view('admin.report.fxreportbycountry')->with(['pages' => 'Dashboard', 'clientPay' => $clientPay, 'adminUser' => $adminUser, 'invoiceImport' => $invoiceImport, 'payInvoice' => $payInvoice, 'otherPays' => $otherPays, 'transCost' => $transCost, 'data' => $data]);
        } else {
            return redirect()->route('AdminLogin');
        }
    }
