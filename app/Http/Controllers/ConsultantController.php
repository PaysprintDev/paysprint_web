    ...
    public function store(Request $req, Consultant $consultant)
    {
        ...
        if (count($checkExist) > 0) {
            ...
            if ($result == true) {
                ...
                $this->message = "Hi " . $this->name . ", <br><br> <b>" . $req->owner_name . "</b> registered you as one of their consultant on PaySprint.<br>. <br><br> Kindly follow these steps to manage the Request: <br> a. Click on this link <a href='https://paysprint.ca/AdminLogin'>https://paysprint.ca/AdminLogin</a> to login to PaySprint Account. <br> b. Go to Manage Rental Property on Free Business App and Select Service Provider <br><br> Thanks <br> PaySprint Management.";
