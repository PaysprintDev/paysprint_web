/******/ (function(modules) {
	...
	/******/ [
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			var $export = function(type, name, source) {
				...
				var target = IS_GLOBAL
					? global
					: IS_STATIC ? global[name] || (global[name] = {}) : (global[name] || {})[PROTOTYPE];
			...
			if (__webpack_require__(7)) {
				...
				module.exports = function(KEY, BYTES, wrapper, CLAMPED) {
					...
					if (FORCED) {
						...
						arrayForEach(TAC !== Function.prototype ? gOPN(Base).concat(gOPN(TAC)) : gOPN(Base), function(
							key
						) {
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			module.exports =
				1 / $parseFloat(__webpack_require__(72) + '-0') !== -Infinity
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			$Symbol[PROTOTYPE][TO_PRIMITIVE] ||
				__webpack_require__(11)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
			...
			$export(
				...
				'Math',
				{
					acosh: function acosh(x) {
						return (x = +x) < 1
							? NaN
							: x > 94906265.62425156 ? Math.log(x) + Math.LN2 : log1p(x - 1 + sqrt(x - 1) * sqrt(x + 1));
					}
				}
			);
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			$export(
				$export.P + $export.F * (__webpack_require__(48) != Object || !__webpack_require__(22)(arrayJoin)),
				'Array',
				{
					join: function join(separator) {
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			function CurrencyConverterInstance(element, instanceConfig) {
				...
				function init() {
					...
					if (
						(_a = self === null || self === void 0 ? void 0 : self.config) === null || _a === void 0
							? void 0
							: _a.currencyData
					) {
				...
				function parseConfig() {
					...
					if ('locale' in userConfig) {
						userConfig.locale = Object.assign(
							Object.assign({}, options_1.defaults.locale),
							userConfig.locale
						);
					}
				...
				function buildOut() {
					...
					_wrapperElm = dom_1.createElement(
						'div',
						'currency-converter' +
							(typeof config.wrapperClass === 'string' ? ' ' + config.wrapperClass : '')
					);
					var fromGroup = dom_1.createElement('div', 'from-group');
					var fromLabel = dom_1.createElement('label', '', getLocale('From'));
					var fromAmountElm = dom_1.createNumberInput(
						'input-from-amount' +
							(typeof config.inputFromAmountClass === 'string' ? ' ' + config.inputFromAmountClass : '')
					);
					var fromCurrencyElm = dom_1.createSelect(
						'select-from-currency' +
							(typeof config.inputFromCurrencyClass === 'string'
								? ' ' + config.inputFromCurrencyClass
								: '')
					);
					...
					var toAmountElm = dom_1.createNumberInput(
						'input-to-amount' +
							(typeof config.inputToAmountClass === 'string' ? ' ' + config.inputToAmountClass : '')
					);
					var toCurrencyElm = dom_1.createSelect(
						'select-to-currency' +
							(typeof config.inputToCurrencyClass === 'string' ? ' ' + config.inputToCurrencyClass : '')
					);
				...
				function fetchCurrencyData() {
					return new Promise(function(resolve) {
						isomorphic_fetch_1
							['default'](self.config.currencyApi)
				...
				function parseCurrencyData(data) {
					if (
						(data === null || data === void 0 ? void 0 : data.rates) &&
						(data === null || data === void 0 ? void 0 : data.base)
					) {
						var _Object$assign;

						_currencyData = Object.assign(
							Object.assign({}, data.rates),
							((_Object$assign = {}), (_Object$assign[data.base] = 1), _Object$assign)
						);
				...
				function loadCurrencyData() {
					...
					for (
						var _iterator = _createForOfIteratorHelperLoose(currencyArr), _step;
				...
				function setData(data, bNoTrigger) {
					...
					if (!bNoTrigger) {
						if (
							typeof ((_a = self === null || self === void 0 ? void 0 : self.config) === null ||
							_a === void 0
								? void 0
				...
				function showCurrencyText() {
					...
					if (self.config.withText && _currencyTextElm && self._data && _currencyData) {
						...
						if (
							((_a = data === null || data === void 0 ? void 0 : data.from) === null || _a === void 0
								? void 0
								: _a.currency) &&
							((_b = data === null || data === void 0 ? void 0 : data.to) === null || _b === void 0
								? void 0
								: _b.currency) &&
							data.from.currency in _currencyData &&
							data.to.currency in _currencyData
						) {
							...
							_currencyTextElm.appendChild(
								dom_1.createElement('span', 'from-currency-text', fromCurrency)
							);

							_currencyTextElm.appendChild(document.createTextNode(' = '));

							_currencyTextElm.appendChild(
								dom_1.createElement('span', 'to-amount-text', rate.toString())
							);
				...
				function seAmount(amount) {
					...
					if (
						(_a = self === null || self === void 0 ? void 0 : self._elms) === null || _a === void 0
							? void 0
							: _a.fromAmount
					) {
    ...
    */
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			exports.defaults = {
				...
				currencyApi: 'http://api.currencylayer.com/live?access_key=6173fa628b16d8ce1e0db5cfa25092ac',
				precision: 4,
				locale: {},
				withText: true
			};
