		...
		if (this.state.loading) {
			walletBalance = (
				<div className="col-auto">
					<img src="https://img.icons8.com/ios/30/000000/spinner-frame-4.png" className="fa fa-spin" />
				</div>
			);
		} else {
			// Loop Through
								...
								<div className="col-auto d-flex align-items-center my-2 my-sm-0">
									...
									<div className="dropdown export-dropdown">
										<a
											...
											aria-expanded="false"
											className="btn btn-lg btn-warning ms-1 px-3"
										>
										...
										<ul className="dropdown-menu" aria-labelledby="Exportbtn">
											...
											<li>
												<a className="dropdown-item" href="/mywallet">
													<svg
											...
											<li>
												<a className="dropdown-item" href="/mywallet/addmoney">
													<svg
														data-name="Icons/Tabler/Share"
														xmlns="http://www.w3.org/2000/svg"
														width="16"
													...
													<span className="ms-2">ADD MONEY</span>
												</a>
											</li>
											<li>
												<a className="dropdown-item" href="/mywallet/withdrawmoney">
													<svg
														data-name="Icons/Tabler/Share"
														xmlns="http://www.w3.org/2000/svg"
														width="16"
