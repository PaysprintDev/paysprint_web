					...
					<a href="#" className="dropdown-item text-wrap" key={item.id}>
						<div className="media">
							<span className="d-flex align-items-center">
								<span className="avatar-status avatar-sm-status avatar-offline position-relative me-2 end-0 bottom-0">
									&nbsp;
								</span>
								<span className="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white">
									<img
							...
							<div className="media-body ps-1">
								<div className="d-flex align-items-center">
									<span className="fs-16 font-weight-semibold dropdown-title">
										PaySprint {item.platform}
									</span>
									<span className="font-weight-semibold tiny text-gray-600 ms-auto">
										{item.period}
									</span>
								</div>
