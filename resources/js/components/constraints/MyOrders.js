    ...
    <div className="px-3 px-xxl-5 py-3 py-lg-4 border-bottom border-gray-200 after-header">
      <div className="container-fluid px-0">
        <div className="row align-items-center">
          <div className="col">
            <span className="text-uppercase tiny text-gray-600 Montserrat-font font-weight-semibold">Currency Exchange</span>
      ...
      <div className="container-fluid px-0">
        <div className="mb-2 mb-md-3 mb-xl-4 pb-2">
          <ul className="nav nav-tabs nav-tabs-md nav-tabs-line position-relative zIndex-0">
            ...
            <li className="nav-item">
              <Link className="nav-link" to={"/currencyfx/pending"}>Pending Orders</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link active" to={"/currencyfx/myorders"}>My Orders</Link>
            </li>
          </ul>
        </div>
          ...
          <div className="col-12 mb-4">
                    <div className="card rounded-12 shadow-dark-80 border border-gray-50">
                        <div className="d-flex align-items-center px-3 px-md-4 py-3">
                            <h5 className="card-header-title mb-0 ps-md-2 font-weight-semibold">My Orders</h5>
                        ...
                        <div className="table-responsive mb-0">
                            <table className="table card-table table-nowrap overflow-hidden">
                              ...
                              <tr>
                                ...
                                <td><span className="font-weight-semibold text-gray-700">Bid Pending</span></td>
                                <td>
