...
class Header extends Component {
    ...
    render() {
        ...
        if (this.state.loading) {
            data_HTML_HEADER_CONTENT = <div className="dropdown profile-dropdown"><img src="https://img.icons8.com/ios/35/000000/spinner-frame-4.png" className="fa fa-spin" /></div>;
        }
        else {
            if (this.state.data.accountType == "Individual") {
                data_HTML_HEADER_CONTENT = <div className="dropdown profile-dropdown">
                    <a href="#" className="avatar avatar-sm avatar-circle ms-4 ms-xxl-5" data-bs-toggle="dropdown"
                        aria-expanded="false" id="dropdownMenuButton">
                        <img className="avatar-img" src={`${this.state.data.avatar}`} alt={`${this.state.data.name}`} />
                        <span className="avatar-status avatar-sm-status avatar-success">&nbsp;</span>
                    </a>
                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                        <li className="pt-2 px-4">
                            <span className="fs-16 font-weight-bold text-black-600 Montserrat-font me-2">{this.state.data.name}</span><img
                                src="https://fabrx.co/preview/muse-dashboard/assets/svg/icons/fill-check.svg"
                                alt="icon" />
                        </li>

                        <li>
                            <a className="dropdown-item" href="/profile"><svg data-name="Icons/Tabler/Share"
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                <rect id="Icons_Tabler_User_background" data-name="Icons/Tabler/User background"
                            ...
                            </svg><span className="ms-2">Profile</span></a>
                        </li>
                        ...
                        <li>
                            <a className="dropdown-item" href="/profile"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                <path data-name="Combined Shape"
                                    ...
                                    fill="#495057" />
                            </svg><span className="ms-2">Settings</span></a>
                        </li>
                    </ul>
                </div>;
            } else {
                data_HTML_HEADER_CONTENT = <div className="dropdown profile-dropdown">
                    <a href="#" className="avatar avatar-sm avatar-circle ms-4 ms-xxl-5" data-bs-toggle="dropdown"
                        aria-expanded="false" id="dropdownMenuButton">
                        <img className="avatar-img" src={`${this.state.data.avatar}`} alt={`${this.state.data.businessname}`} />
                        <span className="avatar-status avatar-sm-status avatar-success">&nbsp;</span>
                    </a>
                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                        <li className="pt-2 px-4">
                            <span className="fs-16 font-weight-bold text-black-600 Montserrat-font me-2">{this.state.data.businessname}</span><img
                                src="https://fabrx.co/preview/muse-dashboard/assets/svg/icons/fill-check.svg"
                                alt="icon" />
                        </li>

                        <li>
                            <a className="dropdown-item" href="/Admin/merchant/profile"><svg data-name="Icons/Tabler/Share"
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                <rect id="Icons_Tabler_User_background" data-name="Icons/Tabler/User background"
                                    width="16" height="16" fill="none" />
                                <path
                        ...
                        <li>
                            <a className="dropdown-item" href="/Admin/merchant/profile"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" viewBox="0 0 16 16">
                                <path data-name="Combined Shape"
                                    d="M6.027,14.449a.8.8,0,0,0-1.193-.494,2.025,2.025,0,0,1-1.063.31,2.086,2.086,0,0,1-1.779-1.069,1.961,1.961,0,0,1,.051-2.03.8.8,0,0,0-.493-1.193,2.03,2.03,0,0,1,0-3.945.8.8,0,0,0,.494-1.193,1.962,1.962,0,0,1-.052-2.03,2.086,2.086,0,0,1,1.78-1.071,2.022,2.022,0,0,1,1.062.31.8.8,0,0,0,1.193-.493,2.03,2.03,0,0,1,3.945,0,.808.808,0,0,0,.472.551.788.788,0,0,0,.305.06.8.8,0,0,0,.417-.117,2.024,2.024,0,0,1,1.062-.31,2.087,2.087,0,0,1,1.78,1.07,1.963,1.963,0,0,1-.052,2.03.8.8,0,0,0,.494,1.192,2.03,2.03,0,0,1,0,3.946.8.8,0,0,0-.494,1.193,1.962,1.962,0,0,1,.052,2.03,2.086,2.086,0,0,1-1.779,1.07,2.025,2.025,0,0,1-1.063-.31.8.8,0,0,0-.722-.056.8.8,0,0,0-.471.55,2.03,2.03,0,0,1-3.945,0Zm0-1.687a2.03,2.03,0,0,1,1.2,1.4.8.8,0,0,0,1.553,0A2.029,2.029,0,0,1,11.8,12.9l.077.042a.78.78,0,0,0,.341.08.822.822,0,0,0,.7-.421.773.773,0,0,0-.02-.8l-.078-.141a2.03,2.03,0,0,1,1.333-2.889.8.8,0,0,0,0-1.552A2.031,2.031,0,0,1,12.9,4.195l.042-.076a.768.768,0,0,0-.042-.757.813.813,0,0,0-.68-.387.793.793,0,0,0-.418.122l-.141.078a2.038,2.038,0,0,1-.916.219,2.02,2.02,0,0,1-.777-.155,2.039,2.039,0,0,1-1.2-1.4l-.029-.1a.8.8,0,0,0-1.524.1A2.027,2.027,0,0,1,4.195,3.1l-.076-.041a.78.78,0,0,0-.341-.08.822.822,0,0,0-.7.422.772.772,0,0,0,.021.8l.078.141A2.029,2.029,0,0,1,1.841,7.223a.8.8,0,0,0,0,1.553A2.029,2.029,0,0,1,3.1,11.8l-.041.077a.768.768,0,0,0,.042.757.815.815,0,0,0,.68.387.791.791,0,0,0,.418-.122l.141-.078a2.027,2.027,0,0,1,1.693-.064ZM4.923,8A3.077,3.077,0,1,1,8,11.077,3.081,3.081,0,0,1,4.923,8ZM6.154,8A1.846,1.846,0,1,0,8,6.154,1.848,1.848,0,0,0,6.154,8Z"
                                    fill="#495057" />
                    ...
                    <div className="container-fluid px-0">
                        <div className="header-body px-3 px-xxl-5 py-3 py-lg-4">
                            <div className="row align-items-center">
                                <a href="#" className="muze-hamburger d-block d-lg-none col-auto"><img src="https://res.cloudinary.com/pilstech/image/upload/v1633640629/paysprint_asset/hamburger1_qkzb73.svg" alt="img" /><img src="https://res.cloudinary.com/pilstech/image/upload/v1633640676/paysprint_asset/close1_kk4ugu.svg" style={{ width: "20px" }} className="menu-close" alt="img" /></a>
                                <a className="navbar-brand mx-auto d-lg-none col-auto px-0" href="#"><img src="https://res.cloudinary.com/pilstech/image/upload/v1603726392/pay_sprint_black_horizotal_fwqo6q.png" alt="PaySprint" style={{ width: "120px" }} /><img src="https://res.cloudinary.com/pilstech/image/upload/v1603726392/pay_sprint_black_horizotal_fwqo6q.png" alt="Muze" className="white-logo" /></a>
                                <div className="col d-flex align-items-center">
                                    <a href="#"
                                        className="back-arrow bg-white circle circle-sm shadow border border-gray-200 rounded mb-0"><svg
                                        ...
                                        <div className="navbar-collapse">
                                            <ul className="navbar-nav" id="accordionExample2">
                                                <li className="nav-item">
                                                    <a className="nav-link collapsed" href="#sidebarDashboards2" data-bs-toggle="collapse"
                                                ...
                                                <li className="nav-item">
                                                    <a className="nav-link collapsed" href="#sidebarSendMoney1" data-bs-toggle="collapse"
                                                        role="button" aria-expanded="false" aria-controls="sidebarSendMoney1">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                            viewBox="0 0 16 16">
                                                            <g data-name="icons/tabler/chart" transform="translate(0)">
                                                                <rect data-name="Icons/Tabler/Chart background" width="16" height="16"
                                                    ...
                                                    <div className="collapse collapse-box" id="sidebarSendMoney1"
                                                        ...
                                                        <ul className="nav nav-sm flex-column">
                                                            ...
                                                            <li className="nav-item">
                                                                <a href={`/payorganization?type=${btoa('international')}`} className="nav-link">International</a>
                                                            </li>
                                                ...
                                                <li className="nav-item">
                                                    <a className="nav-link collapsed" href="#sidebarMarketPlace3" data-bs-toggle="collapse"
                                                        role="button" aria-expanded="false" aria-controls="sidebarMarketPlace3">
                                                ...
                                                <li className="nav-item">
                                                    <a className="nav-link collapsed" href="/mywallet" data-bs-toggle="collapse"
                                                        role="button" aria-expanded="false" aria-controls="sidebarEWallet2">
                                                ...
                                                <li className="nav-item">
                                                    <a className="nav-link collapsed" href="/Statement" data-bs-toggle="collapse"
                                                        role="button" aria-expanded="false" aria-controls="sidebarBankAccount2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                            viewBox="0 0 16 16">
                                                            ...
                                                            className="status bg-warning position-absolute">&nbsp;</sup></span>
                                                    </a>
                            ...
                            <nav className="navbar navbar-expand-lg navbar-light">
                                <div className="navbar-collapse">
                                    <ul className="navbar-nav" id="accordionExample3">
                                        <li className="nav-item">
                                            <a className="nav-link collapsed" href="#sidebarDashboards3" data-bs-toggle="collapse"
                                        ...
                                        <li className="nav-item">
                                            <a className="nav-link collapsed" href="#sidebarSendMoney2" data-bs-toggle="collapse"
                                                role="button" aria-expanded="false" aria-controls="sidebarSendMoney2">
                                                <svg data-name="Icons/Tabler/Bolt" xmlns="http://www.w3.org/2000/svg" width="16"
                                                    height="16" viewBox="0 0 16 16">
                                            ...
                                            <div className="collapse collapse-box" id="sidebarSendMoney2"
                                        ...
                                        <li className="nav-item">
                                            <a className="nav-link collapsed" href="#sidebarPages4" data-bs-toggle="collapse" role="button"
