...
class ActiveOrders extends Component{
   ...
   async componentDidMount(){
    ...
    this._isMounted = true;
        ...
        const res = await axios.get(`/api/v1/activeorders`, {headers: {Authorization: `Bearer ${this.props.apiToken}`}});
    ...
    componentDidMount() {
        ...
        try {
                ...
                axios.get(`/api/v1/activeorders`, { headers: { Authorization: `Bearer ${this.props.apiToken}` } }).then(res => {
    ...
    render(){
        ...
        if(this.state.loading){
            data_HTML_ACTIVE_ORDERS = <tr><td colSpan="7" align="center"><span className="font-weight-semibold text-gray-700 text-center"><img src="https://img.icons8.com/ios/35/000000/spinner-frame-4.png" className="fa fa-spin"/></span></td></tr>;
        }
        else{

            if(this.state.message != 'success'){
                data_HTML_ACTIVE_ORDERS = <tr><td colSpan="7" align="center"><span className="font-weight-semibold text-gray-700 text-center">{this.state.message}</span></td></tr>;
            }
            else{
                ...
                data_HTML_ACTIVE_ORDERS = this.state.data.map((activeOrders) => {
                    ...
                    if(activeOrders.status == "Sold"){
                        status_HTML = <div className="dropdown-menu dropdown-menu-end">
                ...
                return(
                    ...
                    <td><span className="font-weight-semibold text-gray-700">{activeOrders.order_id}</span></td>
                    <td><span className="font-weight-semibold text-gray-500">{activeOrders.sell+' '+activeOrders.sell_currencyCode}</span></td>
                    <td><span className="font-weight-semibold text-gray-500">{activeOrders.buy+' '+activeOrders.buy_currencyCode}</span></td>
                    <td><span className="font-weight-semibold text-gray-500">{activeOrders.rate}</span></td>
                    <td><span className="font-weight-semibold text-gray-500">{activeOrders.expiry}</span></td>
                    <td><span className="font-weight-semibold text-gray-500" style={{ color:`${activeOrders.color}` }}>{activeOrders.status}</span></td>
                    <td>
                ...
                <div className="col-12 mb-4">
                    <div className="card rounded-12 shadow-dark-80 border border-gray-50">
                        <div className="d-flex align-items-center px-3 px-md-4 py-3">
                            ...
                            <div className="dropdown export-dropdown ms-auto pe-md-2">
                                <a href="#" role="button" id="Sources" data-bs-toggle="dropdown" aria-expanded="false"
                                    ...
                                    </span> <svg className="ms-2" xmlns="http://www.w3.org/2000/svg" width="13"
                                        height="13" viewBox="0 0 13 13">
                                        <rect data-name="Icons/Tabler/Chevron Down background" width="13" height="13"
                                            fill="none" />
                                        <path
                                ...
                                <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="Sources">
                                    <li><a className="dropdown-item" href="#"><span>Today</span></a></li>
                                    <li><a className="dropdown-item" href="#"><span>Yesterday</span></a></li>
                                    <li><a className="dropdown-item" href="#"><span>Last 7 days</span></a></li>
                                    <li><a className="dropdown-item" href="#"><span>This month</span></a></li>
                                    <li><a className="dropdown-item" href="#"><span>Last month</span></a></li>
                                    <li>
                                        <hr className="dropdown-divider" />
                                    </li>
                                    <li><a className="dropdown-item" href="#"><svg data-name="icons/tabler/calendar"
                                            ...
                                            </svg><span className="ms-2">Custom</span></a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="d-flex align-items-center p-3 p-md-4 border-top border-gray-200">
                            <Link to={"/currencyfx/marketplace"} className="my-1 tiny font-weight-semibold mx-auto btn btn-link link-dark">Visit Market Place<svg className="ms-1" data-name="icons/tabler/chevron right"
