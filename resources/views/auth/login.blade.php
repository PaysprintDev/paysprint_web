                ...
                <div class="col-sm-6 contact_info send_message">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <form class="form-inline contact_box" action="{{ route('login') }}" method="POST"
                                id="form-login">
                                @csrf

                                <div class="loginForm animated SlideIn">

                                    <input type="email" name="email" id="loginemail" class="form-control input_box"
                                    ...
                                    <button type="button" class="btn btn-default loginBtn"
                        ...
                        <div role="tabpanel" class="tab-pane disp-0" id="profile">
                            ...
                            <button class="btn btn-danger btn-block" onclick="gotoMerchant()">Login as a
                                Merchant</button>
