...
<head>
    ...
    <title>{{ config('app.name', 'PaySprint') }} | Verification</title>
                ...
                <div class="col-sm-6 contact_info send_message">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"
                                data-toggle="tab">Provide OTP below</a></li>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <p>
                                We have sent a code to your registered email address and mobile number
                            </p>
                            <form class="form-inline contact_box" action="{{ route('verifyotp') }}" method="POST"
                                id="form-login">
                                @csrf

                                <div class="loginForm animated SlideIn">

                                    <input type="number" name="code" id="code" class="form-control input_box"
                                        value="{{ old('code') }}" required autocomplete="code"
                                        placeholder="Verification code *" autofocus>


                                    <button type="submit" class="btn btn-default loginBtn">Proceed</button>
                                    ...
                                    <a class="btn btn-link" href="{{ route('regenerate otp') }}">
                                        {{ __('Didn\'t receive OTP? Resend OTP') }}
                                    </a>
            ...
            if (Boolean(c) == true) {
                ...
                jQuery.ajax({
                    ...
                    success: function(result) {
                        // $('#form-login').submit();
                        setTimeout(function() {
                            location.href = location.origin + "/" + result.link;
                        }, 1000);
                    }
                });
