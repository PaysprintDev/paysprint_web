                                ...
                                <form role="form" action="#" method="POST" id="formElem">
                                    ...
                                    <div class="form-group"> <label for="fx_amount">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" min="0.00" step="0.01" name="fx_amount" id="fx_amount" class="form-control" placeholder="Amount">
                                    ...
                                    <div class="wiredTransfer disp-0">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <p><img src="https://img.icons8.com/color/25/000000/info--v1.png" />
                                                    Please transfer the amount mentioned below to PaySprint and provide the transaction details for the transfer.</p>
                                                <div class="alert alert-info" style="width: 100%;">
                                                    <h5>PaySprint Account Details</h5> <hr>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <em>Please do not forget to add this Reference Number in the notes of your transaction. This will help us quickly process your funds</em>
                                                            <hr>
                                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="fx_payment_bank_name" id="fx_payment_bank_name" class="form-control" placeholder="Bank Name">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" min="0" step="0" name="fx_account_number" id="fx_account_number" class="form-control" placeholder="Account Number">
                                    ...
                                    <div class="form-group"> <label for="fx_account_name">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-append"> <span class="input-group-text text-muted">
                                                    <img src="https://img.icons8.com/external-kiranshastry-lineal-color-kiranshastry/20/000000/external-user-advertising-kiranshastry-lineal-color-kiranshastry-2.png"/>
                                                </span> </div>
                                            <input type="text" name="fx_account_name" id="fx_account_name" class="form-control" placeholder="Account Name">
