                                        ...
                                        <div class="col-md-6">
                                                <div class="alert alert-warning">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-5">
                                                            <a href="{{ route('my account') }}" style="font-weight: bold; text-decoration: none;">
                                                                PaySpirnt Wallet <img src="https://img.icons8.com/external-justicon-flat-justicon/30/000000/external-wallet-ecommerce-justicon-flat-justicon.png"/>
                                                            </a>
                                                        </div>
                                                    </div>
                                            </div>
