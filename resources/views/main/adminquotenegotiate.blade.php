                ...
                <div class="portfolio_item portfolio_2">
                   <div class="grid-sizer-2"></div>
                    <div class="single_facilities col-sm-10 payment">
                        ...
                        <li class="tab-menu active"><a data-toggle="tab" href="#home">Negotiate Quote</a></li>
                        ...
                        <div id="home" class="tab-pane fade in active">
                            ...
                            <div class="subtittle">
                                <h2>Negotiate Quote</h2>
                            </div>

                            <form method="POST" action="{{ route('negotiatequote') }}">
                            ...
                            <div class="billingIns">
                                ...
                                <input type="number" name="negotiation_price" id="negotiation_price" class="form-control billinginput_box" placeholder="0.00" required>
                            </div>


                            <div class="billingIns">
                                <label for="negotiation_reason">Reason <span class="importantfield">*</span></label>
                                <textarea class="form-control" id="negotiation_reason" name="negotiation_reason" rows="4" cols="50"></textarea>
                            </div>
