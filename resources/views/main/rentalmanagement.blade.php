                    ...
                    <div class="card-header">
                        <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                            ...
                            <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                <li class="nav-item"> <a data-toggle="pill" href="{{ route('user home') }}" class="nav-link active "> <i class="fas fa-home"></i> Go Home </a> </li>
                                ...
                                <div class="table table-responsive">
                                    <table class="table table-striped" id="myTableAll">
                                        ...
                                        <tbody>
                                            ...
                                            @if (count($data['getRPM']) > 0)

                                            @php
                                                $i = 1;
                                            @endphp

                                                @foreach ($data['getRPM'] as $data)
