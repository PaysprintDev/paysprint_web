            ...
            <div class="row construction_iner">
                ...
                <div class="col-md-4 col-sm-6 construction">
                   ...
                   <div class="cns-content">
                        ...
                        <center><a href="{{ route('maintenance') }}" class="button_all" style="background-color: #f8b81d !important; padding-bottom: 15px; color: #fff !important; border-radius: 5px; margin-top: 5px; cursor: pointer;">Proceed</a></center>
                   </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6 construction">
                   ...
                   <div class="cns-content">
                        ...
                        <center><a href="{{ route('amenities') }}" class="button_all" style="background-color: #f8b81d !important; padding-bottom: 15px; color: #fff !important; border-radius: 5px; margin-top: 5px;">Proceed</a></center>
                   </div>
                </div>
                <div class="col-md-4 col-sm-6 construction">
                   <div class="cns-img">
            ...
            <div class="row construction_iner">
                ...
                <div class="col-md-4 col-sm-6 construction">
                   ...
                   <div class="cns-content">
                        ...
                        <center><a href="{{ route('paymenthistory') }}" class="button_all" style="background-color: #f8b81d !important; padding-bottom: 15px; color: #fff !important; border-radius: 5px; margin-top: 5px;">Proceed</a></center>
                   </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6 construction">
                   ...
                   <div class="cns-content">
                        ...
                        <center><a href="{{ route('documents') }}" class="button_all" style="background-color: #f8b81d !important; padding-bottom: 15px; color: #fff !important; border-radius: 5px; margin-top: 5px;">Proceed</a></center>
                        {{-- <center><a onclick="comingSoon()" class="button_all" style="background-color: #f8b81d !important; padding-bottom: 15px; color: #fff !important; border-radius: 5px; margin-top: 5px; cursor: pointer;">Proceed</a></center> --}}
