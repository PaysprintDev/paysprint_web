                        ...
                        <div class="tab-content">
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                            ...
                                            <div class="alert alert-info">
                                                        <center>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <p>
                                                                    You are yet to add any card, start adding your card by clicking the add new card below.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        </center>
                                    ...
                                    <div class="form-group row pickCard"> 
                                        <div class="col-md-12">
                                            <button class="btn btn-secondary btn-block" onclick="showForm('card')">Add new Card <i class="fa fa-credit-card"></i></button>
                                        </div>
                                    </div>
