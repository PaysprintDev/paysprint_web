                   ...
                   <div class="grid-sizer-2"></div>
                    <div class="single_facilities col-sm-10 payment">
                        ...
                        <div class="who_we_area">
                            ...
                            <form method="POST" action="{{ URL('Ajax/createMaintenance') }}" enctype="multipart/form-data">
                            ...
                            <div class="billingIns">
                                ...
                                <label for="property_facility">Select Building/Facility <span class="importantfield">*</span></label>
                                <select name="property_facility" class="form-control billinginput_box" id="property_facility" required>
                                </select>
                            </div>

                            <div class="billingIns">
                                <label for="phone_number">Tenant Phone Number <span class="importantfield">*</span></label>
                                <input type="text" name="phone_number" id="phone_number" class="form-control billinginput_box" placeholder="Tenant Phone Number*" required>
                            </div>

                            <div class="billingIns">
                                <label for="unit_id">Tenant Unit and Address <span class="importantfield">*</span></label>
                                <input type="text" name="unit_id" id="unit_id" class="form-control billinginput_box" placeholder="Tenant Unit and Address*" required>
                            </div>
                            ...
                            <div class="billingIns">
                                ...
                                <textarea class="form-control" id="details" name="details" rows="4" cols="50" required></textarea>
                            </div>

                            <div class="billingIns">
                                <label for="additional_info">Additional information: (ie.pets, special entrance instructions etc)</label>
                                <textarea class="form-control" id="additional_info" name="additional_info" rows="4" cols="50"></textarea>
                            </div>

                            <div class="if_yes disp-0">
                                <label for="describe_event">Describe the request to be fixed <span class="importantfield">*</span></label>
                                <textarea class="form-control" id="describe_event" name="describe_event" rows="4" cols="50"></textarea>
                            ...
                            <button type="submit" id="invoice_check" class="btn btn-primary btn-block">Create Request</button>
