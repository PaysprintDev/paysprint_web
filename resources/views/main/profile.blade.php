            ...
            <div class="well well-sm">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <h4>
                            {{ Auth::user()->name }}</h4>
                        <small><cite title="San Francisco, USA"> <b>Location:
                                    {{ Auth::user()->city . ' ' . Auth::user()->state . ', ' . Auth::user()->country }}
                                </b> <i class="fa fa-map-marker">
                                </i></cite></small>
                        <p>
                        ...
                        @if (Auth::user()->country == 'Nigeria')
                            <div class="card alert alert-info">
                                <div class="card-body">
                                    <p>
                                        <i class="fa fa-cc"></i> <b>Bank Account Number:
                        ...
                        <p>
                            <i class="fa fa-user"></i> <b>Account Type:
                                {{ Auth::user()->accountType . ' account' }}</b>
                        </p>
                        <p>
                        ...
                        <p>
                            <i class="fa fa-address-book"></i> <b>Address:
                                {{ Auth::user()->address . ', ' . Auth::user()->city . ' ' . Auth::user()->state . ' ' . Auth::user()->country }}</b>
                        </p>
                        ...
                        <ul>
                            ...
                            @if (Auth::user()->nin_front != null || Auth::user()->nin_back != null)
                                <li style="font-weight: bold;">Government issued photo ID: <br>
                                    <small style="font-weight: bold;"> <a href="{{ Auth::user()->nin_front }}"
                                            target="_blank">Front View</a> | <a href="{{ Auth::user()->nin_back }}"
                                            target="_blank">Back
                                            View</a></small>
                            ...
                            @if (Auth::user()->drivers_license_front != null || Auth::user()->drivers_license_back != null)
                                <li style="font-weight: bold;">Driver's License: <br>
                                    <small style="font-weight: bold;"> <a
                                            href="{{ Auth::user()->drivers_license_front }}" target="_blank">Front
                                            View</a> | <a href="{{ Auth::user()->drivers_license_back }}"
                                            target="_blank">Back
                                            View</a> </small>
                            ...
                            @if (Auth::user()->international_passport_front != null || Auth::user()->international_passport_back != null)
                                <li style="font-weight: bold;">International Passport: <br>
                                    <small style="font-weight: bold;"> <a
                                            href="{{ Auth::user()->international_passport_front }}"
                                            target="_blank">Front View</a> | <a
                                            href="{{ Auth::user()->international_passport_back }}"
                                            target="_blank">Back View</a></small>
                            ...
                            @if (Auth::user()->incorporation_doc_front != null)
                                <li style="font-weight: bold;">Document: <br>
                                    <small style="font-weight: bold;"> <a
                                            href="{{ Auth::user()->incorporation_doc_front }}" target="_blank">View
                                            document</a></small>
                                    ...
                                    <div class="form-group">
                                        <label for="oldpin">Old Pin <strong>
                                                <p class="text-danger" style="cursor: pointer;"
                                                    onclick='resetPin("{{ Auth::user()->securityQuestion }}", "transaction")'>
                                                    Have you forgotten your old transaction pin? Click here to reset
                                                </p>
                                            </strong></label>
                        ...
                        <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <form action="#" method="post" id="formElembvnverification">
                                    ...
                                    <div class="form-group">
                                        <label for="bvn">Bank Verification Number @if (Auth::user()->bvn_verification == null || Auth::user()->bvn_verification == 0)
                                                <strong>
                                        ...
                                        <input type="number" name="bvn" id="bvn" class="form-control"
                                            @if (Auth::user()->bvn_number != null) value="{{ Auth::user()->bvn_number }}" readonly @else placeholder="BVN" @endif>
                                    </div>
                                    ...
                                    @if (Auth::user()->bvn_verification == null || Auth::user()->bvn_verification == 0)
                                        ...
                                        <div class="form-group">
                                            <label for="account_number">Bank Account Number <strong>
                                                    <p class="text-warning" style="cursor: pointer;">Enter your
                                        ...
                                        <div class="form-group">
                                            <label for="bank_code">Select Bank <strong>
                                                    <p class="text-warning" style="cursor: pointer;">Select your
                                                        bank</p>
                                                </strong></label>
                                            <select name="bank_code" id="bank_code" class="form-control">
                                                ...
                                                @if (count($data['listbank']) > 0)
                                                    ...
                                                    @foreach ($data['listbank'] as $banksData)
                                                        <option value="{{ $banksData->code }}">
                                                            {{ $banksData->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                            ...
                            <form action="#" method="post" id="formElempasswordsettings">
                                ...
                                <div class="form-group">
                                    <label for="oldpassword">Old Password <strong>
                                            <p class="text-danger" style="cursor: pointer;"
                                                onclick='resetPin("{{ Auth::user()->securityQuestion }}","password")'>
                                                Have you forgotten your old password? Click here to reset</p>
                                        </strong></label>
                        ...
                        <div class="panel-body">
                            ...
                            <h5>
                                <strong>Security Question: <span
                                        style="color: red">{{ Auth::user()->securityQuestion }}</span></strong>
                            </h5>
                            <hr>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            ...
                            <h5>
                                <strong>Status: <span
                                        style="color: {{ Auth::user()->auto_deposit == 'on' ? 'green' : 'red' }}">{{ strtoupper(Auth::user()->auto_deposit) }}</span></strong>
                            </h5>
                            <hr>
                            <form action="#" method="post" id="formElemautodeposit">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="auto_deposit" id="auto_deposit" class="form-control">
                                        <option value="on"
                                            {{ Auth::user()->auto_deposit == 'on' ? 'selected' : '' }}>ON
                                        </option>
                                        <option value="off"
                                            {{ Auth::user()->auto_deposit == 'off' ? 'selected' : '' }}>OFF
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary btn-block" id="autodepositBtn"
                                        onclick="handShake('autodeposit')">Save</button>
                                </div>
                            ...
                            <form action="#" method="post" id="formElemlinkaccount">
                                ...
                                <div class="form-group">
                                    ...
                                    <small style="color: red; font-weight: 700;">Kindly enter the PS account number
                                        to link</small>
                                    <input type="text" name="account_number" id="link_account_number"
                                        class="form-control" placeholder="E.g 69212">
                                </div>

                                <div class="form-group">
                                    <label for="transaction_pin">Transaction Pin</label><br>
                                    <small style="color: red; font-weight: 700;">Kindly provide transaction pin of
                                        the account to link</small>
                                    <input type="password" name="transaction_pin" id="link_transaction_pin"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary btn-block" id="linkaccountBtn"
                                        onclick="handShake('linkaccount')">Submit</button>
                                </div>
                    ...
                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            ...
                            <form action="#" method="post" id="formElemotheraccount">
                                    ...
                                    <select name="account_number" id="other_account_number" class="form-control">
                                        ...
                                        @if (count($account) > 0)
                                            ...
                                            @foreach ($account as $item)
                                                <option value="{{ $item->link_ref_code }}">
                                                    {{ $item->link_ref_code }}</option>
                                            @endforeach
                                        @else
                                            @php
                                ...
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary btn-block" id="otheraccountBtn"
                                        onclick="handShake('otheraccount')">Submit</button>
                                </div>
                        ...
                        <form action="#" method="post" enctype="multipart/form-data" id="formElem">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name"
                                    value="{{ Auth::user()->name }}" placeholder="Your Name" required readonly>
                            </div>
                            <div class="form-group">
                                <label for="email">Email Address</label>
                                <input type="email" class="form-control" name="email" id="email"
                                    value="{{ Auth::user()->email }}" readonly placeholder="Your Email Address">
                            </div>
                            <div class="form-group">
                                <label for="telephone">Phone Number</label>
                                <input type="tel" class="form-control" name="telephone" id="telephone"
                                    value="{{ Auth::user()->telephone }}" placeholder="Your Phone Number" required>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="dayOfBirth" id="dayOfBirth" class="form-control" required>
                                            @for ($i = 1; $i <= 31; $i++)
                                                <option value="{{ $i }}"
                                                    {{ Auth::user()->dayOfBirth == $i ? 'selected' : '' }}>
                                                    {{ $i }}</option>
                                            @endfor
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="monthOfBirth" id="monthOfBirth" class="form-control" required>
                                            <option selected value='1'
                                                {{ Auth::user()->monthOfBirth == 1 ? 'selected' : '' }}>January
                                            </option>
                                            <option value='2'
                                                {{ Auth::user()->monthOfBirth == 2 ? 'selected' : '' }}>
                                                February</option>
                                            <option value='3'
                                                {{ Auth::user()->monthOfBirth == 3 ? 'selected' : '' }}>March
                                            </option>
                                            <option value='4'
                                                {{ Auth::user()->monthOfBirth == 4 ? 'selected' : '' }}>April
                                            </option>
                                            <option value='5'
                                                {{ Auth::user()->monthOfBirth == 5 ? 'selected' : '' }}>May
                                            </option>
                                            <option value='6'
                                                {{ Auth::user()->monthOfBirth == 6 ? 'selected' : '' }}>June
                                            </option>
                                            <option value='7'
                                                {{ Auth::user()->monthOfBirth == 7 ? 'selected' : '' }}>July
                                            </option>
                                            <option value='8'
                                                {{ Auth::user()->monthOfBirth == 8 ? 'selected' : '' }}>August
                                            </option>
                                            <option value='9'
                                                {{ Auth::user()->monthOfBirth == 9 ? 'selected' : '' }}>
                                                September</option>
                                            <option value='10'
                                                {{ Auth::user()->monthOfBirth == 10 ? 'selected' : '' }}>
                                                October</option>
                                            <option value='11'
                                                {{ Auth::user()->monthOfBirth == 11 ? 'selected' : '' }}>
                                                November</option>
                                            <option value='12'
                                                {{ Auth::user()->monthOfBirth == 12 ? 'selected' : '' }}>
                                                December</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="yearOfBirth" id="yearOfBirth" class="form-control">
                                            @for ($i = 1900; $i <= date('Y'); $i++)
                                                <option value="{{ $i }}"
                                                    {{ Auth::user()->yearOfBirth == $i ? 'selected' : '' }}>
                                                    {{ $i }}</option>
                                            @endfor
                                        </select>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address" id="address"
                                    value="{{ Auth::user()->address }}" placeholder="Your Home Address" required>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="country" id="country"
                                            value="{{ Auth::user()->country }}" placeholder="Your Country" required
                                            readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="city" id="city"
                                            value="{{ Auth::user()->city }}" placeholder="Your City" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control"
                                            name="international_passport_front" id="international_passport_front">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" name="international_passport_back"
                                            id="international_passport_back">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="incorporation_doc_front" class="text-danger">Utility
                                            Bill</label>
                                        <input type="file" class="form-control" name="incorporation_doc_front"
                                            id="incorporation_doc_front">
                                    </div>
                                </div>
                                {{-- <div class="col-md-6">
                                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="button" onclick="handShake('updateprofile')"
                                    class="btn btn-primary btn-block" id="updateBtn">Update Profile</button>
                            </div>
