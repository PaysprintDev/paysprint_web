            ...
            <div class="well well-sm">
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <a href="{{ Auth::user()->avatar }}" target="_blank"><img src="{{ Auth::user()->avatar != null ? Auth::user()->avatar : 'https://cdn.business2community.com/wp-content/uploads/2017/08/blank-profile-picture-973460_640.png' }}" alt="" class="img-rounded img-responsive" style="height: 150px; width: 150px; border-radius: 100%;" /></a>
                    </div>
                    <div class="col-sm-6 col-md-8">
                        ...
                        <ul>
                            ...
                            <li style="font-weight: bold;">Government issued photo ID: <br>
                                <small style="font-weight: bold;"> <a href="{{ Auth::user()->nin_front }}" target="_blank">Front View</a> | <a href="{{ Auth::user()->nin_back }}" target="_blank">Back
                                        View</a></small>
                            ...
                            <li style="font-weight: bold;">Driver's License: <br>
                                <small style="font-weight: bold;"> <a href="{{ Auth::user()->drivers_license_front }}" target="_blank">Front
                                        View</a> | <a href="{{ Auth::user()->drivers_license_back }}" target="_blank">Back
                                        View</a> </small>
                            ...
                            <li style="font-weight: bold;">Document: <br>
                                <small style="font-weight: bold;"> <a href="{{ Auth::user()->incorporation_doc_front }}" target="_blank">View
                                        document</a></small>
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            ...
                            <form action="#" method="post" id="formElemtransactionpinsettings">
                                ...
                                <div class="form-group">
                                    <label for="oldpin">Old Pin <strong>
                                            <p class="text-danger" style="cursor: pointer;" onclick='resetPin("{{ Auth::user()->securityQuestion }}", "transaction")'>
                            ...
                            <form action="#" method="post" id="formElempasswordsettings">
                                ...
                                <div class="form-group">
                                    <label for="oldpassword">Old Password <strong>
                                            <p class="text-danger" style="cursor: pointer;" onclick='resetPin("{{ Auth::user()->securityQuestion }}","password")'>
                            ...
                            <form action="#" method="post" id="formElemsecurityquestans">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="securityQuestion" id="securityQuestion" class="form-control">
                                        ...
                                        <option value="What was your first pet's name?" {{ Auth::user()->securityQuestion == "What was your first pet's name?" ? 'selected' : '' }}>
                                            What was your first pet's name?</option>
                                        <option value="What is the name of the city where you were born?" {{ Auth::user()->securityQuestion == 'What is the name of the city where you were born?' ? 'selected' : '' }}>
                                            What is the name of the city where you were born?</option>
                                        <option value="What was your childhood nickname?" {{ Auth::user()->securityQuestion == 'What was your childhood nickname?' ? 'selected' : '' }}>
                                            What was your childhood nickname?</option>
                                        <option value="What is the name of the city where your parents met?" {{ Auth::user()->securityQuestion == 'What is the name of the city where your parents met?' ? 'selected' : '' }}>
                                            What is the name of the city where your parents met?</option>
                                        <option value="What is the first name of your oldest cousin?" {{ Auth::user()->securityQuestion == 'What is the first name of your oldest cousin?' ? 'selected' : '' }}>
                                            What is the first name of your oldest cousin?</option>
                                        <option value="What is the name of the first school you attended?" {{ Auth::user()->securityQuestion == 'What is the name of the first school you attended?' ? 'selected' : '' }}>
                            ...
                            <form action="#" method="post" id="formElemautodeposit">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="auto_deposit" id="auto_deposit" class="form-control">
                                        <option value="on" {{ Auth::user()->auto_deposit == 'on' ? 'selected' : '' }}>ON
                                        </option>
                                        <option value="off" {{ Auth::user()->auto_deposit == 'off' ? 'selected' : '' }}>OFF
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
                        <div class="panel-body">
                            <form action="#" method="post" id="formElemvouchaccount">
                                ...
                                <div class="form-group">
                                    <label for="transaction_pin">Transaction Pin</label><br>
                                    <small style="color: red; font-weight: 700;">Kindly provide transaction pin of
                                        the account to vouch for</small>
                                    <input type="password" name="transaction_pin" id="link_transaction_pin" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="dayOfBirth" id="dayOfBirth" class="form-control" required>
                                            @for ($i = 1; $i <= 31; $i++) <option value="{{ $i }}" {{ Auth::user()->dayOfBirth == $i ? 'selected' : '' }}>
                                                {{ $i }}</option>
                                                @endfor
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="monthOfBirth" id="monthOfBirth" class="form-control" required>
                                            <option selected value='1' {{ Auth::user()->monthOfBirth == 1 ? 'selected' : '' }}>January
                                            </option>
                                            <option value='2' {{ Auth::user()->monthOfBirth == 2 ? 'selected' : '' }}>
                                                February</option>
                                            <option value='3' {{ Auth::user()->monthOfBirth == 3 ? 'selected' : '' }}>March
                                            </option>
                                            <option value='4' {{ Auth::user()->monthOfBirth == 4 ? 'selected' : '' }}>April
                                            </option>
                                            <option value='5' {{ Auth::user()->monthOfBirth == 5 ? 'selected' : '' }}>May
                                            </option>
                                            <option value='6' {{ Auth::user()->monthOfBirth == 6 ? 'selected' : '' }}>June
                                            </option>
                                            <option value='7' {{ Auth::user()->monthOfBirth == 7 ? 'selected' : '' }}>July
                                            </option>
                                            <option value='8' {{ Auth::user()->monthOfBirth == 8 ? 'selected' : '' }}>August
                                            </option>
                                            <option value='9' {{ Auth::user()->monthOfBirth == 9 ? 'selected' : '' }}>
                                                September</option>
                                            <option value='10' {{ Auth::user()->monthOfBirth == 10 ? 'selected' : '' }}>
                                                October</option>
                                            <option value='11' {{ Auth::user()->monthOfBirth == 11 ? 'selected' : '' }}>
                                                November</option>
                                            <option value='12' {{ Auth::user()->monthOfBirth == 12 ? 'selected' : '' }}>
                                                December</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="yearOfBirth" id="yearOfBirth" class="form-control">
                                            @for ($i = 1900; $i <= date('Y'); $i++) <option value="{{ $i }}" {{ Auth::user()->yearOfBirth == $i ? 'selected' : '' }}>
                                                {{ $i }}</option>
                                                @endfor
                                        </select>
                                    </div>
