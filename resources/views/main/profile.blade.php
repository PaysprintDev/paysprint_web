                            ...
                            <ul>
                                ...
                                @if (Auth::user()->nin_front != null || Auth::user()->nin_back != null)
                                    <li style="font-weight: bold;">Government issued photo ID: <br>
                                        <small style="font-weight: bold;"> <a href="{{ Auth::user()->nin_front }}"
                                                ...
                                                href="{{ Auth::user()->nin_back }}" target="_blank">Back
                                                View</a></small>
                                ...
                                @if (Auth::user()->drivers_license_front != null || Auth::user()->drivers_license_back != null)
                                    ...
                                    <li style="font-weight: bold;">Driver's License: <br>
                                        <small style="font-weight: bold;"> <a
                                                href="{{ Auth::user()->drivers_license_front }}"
                                                target="_blank">Front View</a> | <a
                                                href="{{ Auth::user()->drivers_license_back }}" target="_blank">Back
                                                View</a> </small>
                                ...
                                @if (Auth::user()->incorporation_doc_front != null)
                                    ...
                                    <li style="font-weight: bold;">Document: <br>
                                        <small style="font-weight: bold;"> <a
                                                href="{{ Auth::user()->incorporation_doc_front }}"
                            ...
                            <form action="#" method="post" enctype="multipart/form-data" id="formElem">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" name="telephone" id="telephone"
                                        value="{{ Auth::user()->telephone }}" placeholder="Your Phone Number"
                                        required>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="country" id="country"
                                                value="{{ Auth::user()->country }}" placeholder="Your Country"
                                                required readonly>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nin_back">Back</label>
                                            <input type="file" class="form-control"
                                                name="international_passport_back" id="international_passport_back">
                                        </div>
                                    </div>
                                </div>
