                        ...
                        <div class="tab-content">
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <input type="hidden" name="bank_id"
                                                                value="{{ $myBank->id }}"
                                                                id="bank_id{{ $myBank->id }}">
                                                            <a href="{{ route('Edit bank', $myBank->id) }}"
                                                                title="Edit Bank Detail"><i
                                                                    class="far fa-edit text-secondary"></i></a>
                                                            <a href="javascript:void(0)" title="Delete Bank Detail"
                                                                onclick="delhandShake('deletebank', '{{ $myBank->id }}')"><i
                                                ...
                                                <center>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <p>
                                                                You are yet to add any bank account, start adding your
                                                                bank account by clicking the add bank account below.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </center>
                                ...
                                <div class="form-group row pickCard">
                                    <div class="col-md-12">
                                        <button class="btn btn-secondary btn-block" onclick="showForm('card')">Add Bank
                                            Account <i class="fas fa-university"></i></button>
                                    </div>
                                </div>
                                    ...
                                    <form action="#" method="POST" id="formElem">
                                            ...
                                            <div class="input-group">
                                                ...
                                                @if (Auth::user()->country == 'Canada')
                                                    ...
                                                    <select name="bankName" id="bankName" class="form-control"
                                                        required>
                                                        <option data-tokens="RBC ROYAL BANK" value="RBC ROYAL BANK"> RBC
                                                            ROYAL BANK</option>
                                                        <option data-tokens="TD CANADA TRUST" value="TD CANADA TRUST">TD
                                                            CANADA TRUST</option>
                                                        <option data-tokens="SCOTIABANK" value="SCOTIABANK">SCOTIABANK
                                                        </option>
                                                        <option data-tokens="DESJARDINS" value="DESJARDINS">DESJARDINS
                                                        </option>
                                                        ...
                                                        <option data-tokens="PROSPERA CREDIT UNION"
                                                            value="PROSPERA CREDIT UNION">PROSPERA CREDIT UNION</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group"> <input type="text" name="accountNumber"
                                                    id="accountNumber" class="form-control" required>
                                                <div class="input-group-append">
                                                    <span class="input-group-text text-muted"> <i
                                                            class="fas fa-university"></i></span>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <button type="button" class="btn btn-primary btn-block"
                                                onclick="handShake('addbank')" id="cardSubmit">Submit</button>
                                        </div>
