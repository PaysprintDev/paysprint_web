                                            ...
                                            <div class="alert alert-info">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <a href="{{ route('Edit card', $myBank->id) }}" title="Edit Bank Detail"><i class="far fa-edit text-secondary"></i></a>
                                                                <a href="javascript:void(0)" title="Delete Bank Detail" onclick="handShake('deletecard')"><i class="far fa-trash-alt text-danger"></i></a>
                                                            </div>
                                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group cardform disp-0"> 
                                       <form action="#" method="POST" id="formElem">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="input-group"> <input type="text" name="bankName" id="bankName" class="form-control" required>
