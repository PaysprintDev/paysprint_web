                                    ...
                                    <form action="#" method="POST" id="formElem">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="phone"
                                                value="{{ Auth::user()->code . Auth::user()->telephone }}">

                                            <div class="input-group"> <input type="text" name="name_on_card"
                                                    id="name_on_card" class="form-control" required
                                        ...
                                        <div class="form-group">
                                            <button type="button" class="btn btn-primary btn-block"
                                                onclick="externalhandShake('requestexbccard')" id="cardSubmit">Submit
                                                Request</button>
                                        </div>
            ...
            <script>
                ...
                $('#card_provider').change(function() {
                    ...
                    if ($('#card_provider').val() != null) {
                        textData = "Amount payable to get " + $('#card_provider').val() +
                            " is $20.00. This will be deducted from your wallet. " + $('#card_provider').val() +
                            " issuer would issue the card using your name and address on file";
