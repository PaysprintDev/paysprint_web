                            ...
                            @if (isset($data))
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <form role="form" action="{{ route('receivemoneyProcess') }}" method="POST">
                                        ...
                                        @csrf
                                        <input type="hidden" class="form-control" name="pay_id" id="pay_id"
                                            value="{{ $data['getpay']->orgId }}">
                                        <input type="hidden" class="form-control" name="sender_id" id="sender_id"
                                            value="{{ $data['getpay']->ref_code }}">
                                        ...
                                        <div class="form-group">
                                            <div class="alert alert-info">
                                                <ul>
                                                    ...
                                                    <li>
                                                        City: <b>{{ $data['getpay']->city }}</b> | State/Province:
                                                        <b>{{ $data['getpay']->state }}</b>
                                                    </li>
                                                    <li>
                                        ...
                                        <div class="form-group"> <label for="purpose">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="purpose" id="purpose"
                                                    value="{{ $data['getpay']->purpose }}" readonly
                                                    class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group disp-0 bizInfo">
                                            <small class="text-danger"><b>It may take up to two (2) business days for
                                                    money to reflect in your card</b></small>
                                        </div>
                                            ...
                                            <div class="input-group">
                                                <select name="currency" id="currency" class="form-control">
                                                    <option value="{{ $data['currencyCode']->currencyCode }}"
                                                        selected>{{ $data['currencyCode']->currencyCode }}</option>
                                                </select>
                                        ...
                                        <div class="form-group"> <label for="amount_to_receive">
                                            ...
                                            <div class="input-group"> <input type="text" name="amount_to_receive"
                                                    id="amount_to_receive"
                                                    value="{{ $data['getpay']->amount_to_send }}"
                                                    class="form-control" maxlength="16" readonly>
                                        ...
                                        @if (Request::get('country') != $data['getpay']->country)
                                            <div class="form-group"> <label for="netwmount">
                                                    <h6>Currency Conversion <br><small
                                                            class="text-info"><b>Exchange rate today according to
                                                                currencylayer.com</b></small></h6>
                                            ...
                                            <div class="form-group">
                                                <span class="text-danger" style="font-weight: 800">International
                                                    transfers are received in
                                                    USD{{ $data['currencyCode']->currencyCode }} rates</span>
                                            </div>
                                        @endif
                                        ...
                                        <div class="bank_info disp-0">
                                            ...
                                            <div class="form-group">
                                                <span class="text-danger">Please ensure the name on the card is the
                                                    same as the <b>Account Name</b></span>
                                            </div>
                                        ...
                                        <div class="card_info disp-0">
                                            ...
                                            <div class="form-group"> <label for="orgpaycreditcard">
                                                ...
                                                <div class="input-group"> <input type="number" name="creditcard_no"
                                                        id="orgpaycreditcard" placeholder="5199 - 3924 - 2100 - 5430"
                                        ...
                                        <div class="card-footer"> <button type="submit"
                                                class="subscribe btn btn-primary btn-block shadow-sm"> Receive Money
                                            </button>
                                    </form>
                                </div>
                            @else
