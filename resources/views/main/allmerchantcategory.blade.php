...
<script src="https://kit.fontawesome.com/384ade21a6.js"></script>
    ...
    <title>PaySprint | Merchants By Service</title>
    ...
    <div class="container py-5">
        ...
        <div class="row mb-4">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="display-4">Merchants By Service</h1>
            </div>
        </div> <!-- End -->
        <div class="row">
                                ...
                                <div class="table table-responsive">
                                    <table class="table table-striped" id="myTableAll">
                                        ...
                                        <tbody>
                                            ...
                                            @if (count($data['allMerchants']) > 0)

                                            @php
                                                $i = 1;
                                            @endphp

                                                @foreach ($data['allMerchants'] as $merchantData)
                                                
                                            
                                                <tr>
                                                    <td>{{ $i++ }}</td>
                                                    <td>
                                                        <a href="{{ route('merchant category', 'service='.$merchantData->industry) }}">{{ $merchantData->industry }}</a>
                                                    </td>
                                                    <td>
                                                        @if($merchantAvailable = \App\ClientInfo::where('industry', $merchantData->industry)->where('country', Auth::user()->country)->count()) {{ $merchantAvailable }} @endif
                                                    </td>
