                                            ...
                                            @if (count($data['allMerchants']) > 0)
                                                ...
                                                @foreach ($data['allMerchants'] as $merchantData)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ route('merchant category', 'service=' . $merchantData->industry) }}">{{ $merchantData->industry }}</a>
                                                        </td>
                                                        <td>
                                                            @if ($merchantAvailable = \App\ClientInfo::where('industry', $merchantData->industry)->where('country', Auth::user()->country)->count())
                                                                {{ $merchantAvailable }}
                                                            @endif
                                                        </td>
