                                                ...
                                                <div class="col-md-4 pb-4">
                                                    ...
                                                    <div class="card" style="width: 100%;">
                                                        ...
                                                        @if ($logoAsset = \App\EPSVendor::where('billerCode', $vendor->billerCode)->first())
                                                            <img src="{{ $logoAsset->logo }}" class="card-img-top"
                                                                alt="{{ $vendor->productfields[0]->productId }}"
                                                        ...
                                                        <div class="card-body">
                                                            <h5 class="card-title">
                                                                {{ strtoupper($vendor->billerName) }}</h5>
                                                            ...
                                                            <a href="{{ route('buy utility bills', $vendor->productfields[0]->productId . '?' . $billerCode . '&' . $productId . '&' . $billerName) }}"
                                                                class="btn btn-primary">Get Product</a>
                                                        </div>
                                                    </div>
