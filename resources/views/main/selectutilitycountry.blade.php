                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <div class="col-md-4 pb-4">
                                    ...
                                    <div class="card" style="width: 100%;">
                                        ...
                                        <img src="https://res.cloudinary.com/pilstech/image/upload/v1629977135/Flag-Nigeria_dofzva.jpg" class="card-img-top" alt="Nigeria" style="width: 100%; height: 200px;object-fit: contain;">

                                        <div class="card-body">
                                            <h5 class="card-title text-center">Pay Utility Bills In Nigeria</h5>
                                            
                                            <a href="{{ route('utility bills','country=Nigeria') }}" class="btn btn-primary btn-block">Continue</a>
                                        </div>
                                    </div>
