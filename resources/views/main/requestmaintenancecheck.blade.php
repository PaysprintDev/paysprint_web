                ...
                <div class="portfolio_item portfolio_2">
                   <div class="grid-sizer-2"></div>
                    <div class="single_facilities col-sm-12 payment">
                        ...
                        <li class="tab-menu active"><a data-toggle="tab" href="#home">Received Requests</a></li>
                        ...
                        <div id="home" class="tab-pane fade in active">
                            ...
                            <input type="search" name="search" id="search_field" class="form-control" placeholder="Search by request date, tenant name, unit">
                                <br>
                                    ...
                                    @foreach ($statuschecker as $item)
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <i class="fa fa-eye" style="color: navy; font-weight: bold; cursor: pointer;" title="view details" onclick="location.href='/rentalmanagement/admin/maintenance/view/{{ $item->post_id }}'"></i>
