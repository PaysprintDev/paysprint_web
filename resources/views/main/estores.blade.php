    ...
    <div class="container py-5">
        ...
        <div class="row mb-4">
            <div class="col-lg-12 mx-auto text-center">
                <h1 class="display-4">New On MarketPlace</h1>
            </div>
        </div> <!-- End -->
        <div class="row">
                    ...
                    <div class="card-header">
                        <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                            ...
                            <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                <li class="nav-item"> <a data-toggle="pill" href="{{ route('home') }}" class="nav-link active "> <i class="fas fa-home"></i> Go Back Home</a> </li>
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="card" style="width: 100%;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="{{ route('merchant shop now', $user->businessname) }}" class="btn btn-primary">Goto store</a>
                                            </div>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-md-6 mx-auto">
                                        <div class="card" style="width: 100%;">
                                            <img src="https://st4.depositphotos.com/7819052/21803/v/600/depositphotos_218033152-stock-illustration-grunge-red-available-word-rubber.jpg" class="card-img-top" alt="Not available">
                                            <div class="card-body">
                                                <h5 class="card-title">No store available yet</h5>
                                                <p class="card-text">Please check back after sometime.</p>
                                                <a href="{{ route('home') }}" class="btn btn-primary btn-block">Goto
                                                    Homepage</a>
                                            </div>
                                        </div>
                                    </div>
