                                ...
                                <tbody id="myTable">
                                    ...
                                    @foreach ($statuschecker as $item)
                                        <tr>
                                            ...
                                            @if($dateoff = \App\RentalMessage::where('post_id', $item->maintenance_id)->get())
                                            ...
                                            @if($busInfo = \App\MaintenanceRequest::where('post_id', $item->maintenance_id)->get())

                                                @if(count($busInfo) > 0)

                                                    <td>{{ $busInfo[0]->subject }}</td>
                                                    <td style="text-align: left">{!! \Illuminate\Support\Str::limit($busInfo[0]->details, 50, $end='...') !!}</td>
                                                    <td>{{ $busInfo[0]->priority }}</td>
                                                    <td>{{ $busInfo[0]->status }}</td>
                                            ...
                                            <td align="center">
                                                <i class="fa fa-eye" style="color: navy; font-weight: bold; cursor: pointer;" title="view details" onclick="location.href='/rentalmanagement/consultant/maintenance/{{ $item->maintenance_id }}'"></i>
