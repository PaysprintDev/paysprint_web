...
@section('content')
    ...
    <div class="contact_map">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11540.856121918176!2d-79.76125808993915!3d43.68531360041938!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b1597c120173b%3A0x8c0309afa99d74d2!2s10%20George%20St%20N%2C%20Brampton%2C%20ON%20L6X%201R2%2C%20Canada!5e0!3m2!1sen!2sng!4v1570213666176!5m2!1sen!2sng"
            width="1300" height="600" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
    </div>
    <!-- End Map -->
            ...
            <div class="row contact_row">
                <div class="col-sm-6 contact_info">
                    ...
                    <div class="location">
                        ...
                        <div class="address">
                            <a href="#">PaySprint by Express Ca Corp, <br>10 George St. North, Brampton. ON. L6X1R2. Canada
                            </a>
                ...
                <div class="col-sm-6 contact_info send_message">
                    ...
                    <div id='crmWebToEntityForm' class='zcwf_lblLeft crmWebToEntityForm'
                        ...
                        <form action='https://crm.zoho.com/crm/WebToLeadForm' name=WebToLeads3264094000003951005
                            method='POST'
                            onSubmit='javascript:document.charset="UTF-8"; return checkMandatory3264094000003951005()'
                            accept-charset='UTF-8'>
                            <input type='text' style='display:none;' name='xnQsjsdp'
                                value='e8a3ad69df258ca810f448198a40c5f49ec7b96fc72f3f356f1e05ba5c8270ce'></input>
                            <input type='hidden' name='zc_gad' id='zc_gad' value=''></input>
                            <input type='text' style='display:none;' name='xmIwtLD'
                                value='b7676fb486c62b9e48e985479454d494e8f5b69c5eb1610f2599f52edfa654f5'></input>
                            <input type='text' style='display:none;' name='actionType' value='TGVhZHM='></input>
                            <input type='text' style='display:none;' name='returnURL'
                                value='https&#x3a;&#x2f;&#x2f;paysprint.ca'> </input>
                            ...
                            <div class='zcwf_row'>
                                <div class='zcwf_col_lab' style='font-size:12px; font-family: Arial;'><label
                                        for='Last_Name'>Last Name<span style='color:red;'>*</span></label></div>
                            ...
                            <div class='zcwf_row'>
                                <div class='zcwf_col_lab' style='font-size:12px; font-family: Arial;'><label
                                        for='First_Name'>First Name<span style='color:red;'>*</span></label></div>
                                <div class='zcwf_col_fld'><input type='text' id='First_Name' name='First Name'
                                        maxlength='40' class='form-control'></input>
                                    <div class='zcwf_col_help'></div>
                                </div>
                            </div>
                            <div class='zcwf_row'>
                                ...
                                <div class='zcwf_col_fld'><input type='text' ftype='email' id='Email' name='Email'
                                        maxlength='100' class='form-control'></input>
                                    <div class='zcwf_col_help'></div>
                                </div>
                            </div>
                            <div class='zcwf_row'>
                                <div class='zcwf_col_lab' style='font-size:12px; font-family: Arial;'><label
                                        for='Phone'>Phone<span style='color:red;'>*</span></label></div>
                            ...
                            <div class='zcwf_row'>
                                ...
                                <div class='zcwf_col_fld'><img id='imgid3264094000003951005'
                                        src='https://crm.zoho.com/crm/CaptchaServlet?formId=b7676fb486c62b9e48e985479454d494e8f5b69c5eb1610f2599f52edfa654f5&grpid=e8a3ad69df258ca810f448198a40c5f49ec7b96fc72f3f356f1e05ba5c8270ce'>
                            ...
                            <div class='zcwf_row'>
                                ...
                                <div class='zcwf_col_fld'><input type='submit' id='formsubmit'
                                        class='formsubmit zcwf_button' value='Submit' title='Submit'><input type='reset'
                                        class='zcwf_button' name='reset' value='Reset' title='Reset'></div>
                            </div>
                            <script>
                                /* Do not remove this code. */
                    ...
                    <form class="form-inline contact_box disp-0">
                        <label for="name"><span style="color: red !important; display: inline; float: none;">*</span>
                            Name</label>
                        <input id="name" type="text" class="form-control input_box"
                            @if ($name != '') value="{{ $name }}" readonly @else placeholder="Name *" @endif>
                        <label for="email"><span style="color: red !important; display: inline; float: none;">*</span>
                            Email</label>
                        <input id="email" type="text" class="form-control input_box"
                            @if ($email != '') value="{{ $email }}" readonly @else placeholder="Your Email *" @endif>
