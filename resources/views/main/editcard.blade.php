                                            ...
                                            <div class="alert {{ $alertInfo }}">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <h6>
                                                            Expiry:
                                                            {{ $data['getthisCard']->month . '/' . $data['getthisCard']->year }}
                                                        </h6>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <h6>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input type="hidden" name="card_id"
                                                            value="{{ $data['getthisCard']->id }}"
                                                            id="card_id{{ $data['getthisCard']->id }}">
                                                        <a href="#" title="Edit Card"><i
                                                                class="far fa-edit text-secondary"></i></a>
                                                        <a href="javascript:void(0)" title="Delete Card"
                                                            onclick="delhandShake('deletecard', '{{ $data['getthisCard']->id }}')"><i
                                        ...
                                        <form action="#" method="POST" id="formElem">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group"> <input type="text" name="card_name"
                                                        id="card_name" value="{{ $data['getthisCard']->card_name }}"
                                            ...
                                            <div class="input-group">
                                                <select name="card_provider" id="card_provider" class="form-control"
                                                    required>
                                                    <option value="">Select Card Issuer</option>
                                                    <option value="{{ $data['getthisCard']->card_provider }}"
                                                        selected>{{ $data['getthisCard']->card_provider }}</option>
                                                    ...
                                                    @if (count($data['cardIssuer']) > 0)
                                                        ...
                                                        @endforeach
                                                    @else
                                                        <option value="EXBC Prepaid Card">EXBC Prepaid Card from EXBC
                                                        </option>
                                                    @endif
                                                </select>
                                                <div class="input-group-append">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group"> <input type="text" name="card_number"
                                                        id="card_number"
                                                        value="{{ $data['getthisCard']->card_number }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <select name="month" id="month" class="form-control"
                                                                ...
                                                                <option value="{{ $data['getthisCard']->month }}"
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <select name="year" id="year" class="form-control"
                                                                required>
                                                                <option value="{{ $data['getthisCard']->year }}"
                                                                    selected>{{ '20' . $data['getthisCard']->year }}
                                                                </option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="month">CVV <small class="text-danger">3 digit at
                                                                the back of your card</small></label>
                                            ...
                                            <div class="form-group">
                                                <button type="button" class="btn btn-primary btn-block"
                                                    onclick="handShake('editcard')" id="cardSubmit">Submit</button>
                                            </div>
