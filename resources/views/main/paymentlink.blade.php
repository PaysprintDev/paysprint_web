...
<script src="https://www.paypal.com/sdk/js?client-id={{ env('PAYPAL_CLIENT_ID') }}&currency={{ $data['currencyCode']->currencyCode }}"></script>
                    ...
                    <div class="card-header">
                        <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                            ...
                            <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                <li class="nav-item" onclick="location.href='{{ route('home') }}'"> <a data-toggle="pill" href="{{ route('home') }}" class="nav-link active "> <i class="fas fa-home"></i> Explore PaySprint </a> </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                @if($data['currencyCode']->gateway == "Stripe")
                                    ...
                                    <input type="hidden" name="name" class="form-control" id="nameInput" value="{{ $name }}" readonly>

                                    <input type="hidden" name="email" class="form-control" id="emailInput" value="{{ $email }}" readonly>
    ...
    if(val == 'payinvoicelink'){
        ...
        Pace.track(function(){
            ...
            success: function(result){
                ...
                if(result.status == 200){
                        swal("Success", result.message, "success");
                        setTimeout(function(){ location.href="{{ route('home') }}"; }, 2000);
                    }
                    else{
                        swal("Oops", result.message, "error");
                    }
      ...
      metadata: {
         custom_fields: [
            ...
            },
            {
                ...
                value: "Paid invoice of {{ $currencySymb }}"+netamount+" for {{ $data['getinvoice'][0]->service }} to {{ $data['getinvoice'][0]->merchantName }}."
            }
         ]
      },
