                    ...
                    <div class="card-header">
                        ...
                        <div class="tab-content">
                            ...
                            @php
                                $index=1;
                            @endphp
                            @if (count($data['bulkreceiver']) > 0)
                            @foreach ( $data['bulkreceiver'] as $receivers )
                            @if ( $user= \App\User::where('ref_code',$receivers)->first())


                            <!-- credit card info-->
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                <form role="form" action="{{route('create bulk transfer')}}" method="POST" id="paymentForm">
                                    ...
                                    <div class="form-group"> <label for="orgpayservice">
                                        ...
                                        <div class="input-group">
                                            <select name="service[{{$index}}]" id="orgpayservice" class="form-control" required>
                                    ...
                                    <div class="form-group others disp-0"> <label for="orgpaypurpose">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="purpose[{{$index}}]" id="orgpaypurpose" placeholder="Specify Purpose" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" name="currency[{{$index}}]" value="{{ $user->currencyCode}}">
                                            <input type="hidden" name="type[{{$index}}]" value="local">
                                            <div class="input-group">
                                                <select name="localcurrency" id="localcurrency" class="form-control" readonly>
                                                    <option value="{{ $user->currencyCode}}" selected>{{ $user->currencyCode}}
                                                    </option>
                                                </select>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group"> <label for="orgpayamount">
                                                ...
                                                <div class="input-group"> <input type="number" name="amount[{{$index}}]" id="orgpayamount" placeholder="50.00" class="form-control" maxlength="16" required>
