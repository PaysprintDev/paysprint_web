...
@section('content')
    ...
    <section class="banner_area" data-stellar-background-ratio="0.5">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('statement') }}" class="active">SEND YOUR PAYMENT</a></li>
        </ol>
    </section>
    <!-- End Banner area -->
        ...
        <div class="container">
            <div class="architecture_area services_pages">
                <div class="portfolio_filter portfolio_filter_2">
                    <ul>
                        <li data-filter="*" class="active"><a href=""><i class="fa fa-file" aria-hidden="true"></i>Organizations</a></li>
                    </ul>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label for="orgInfo">&nbsp;</label><br>
                                            <button class="btn btn-primary" onclick="checkDetail()">Check details</button>
