    ...
    <div class="container">
        <div class="architecture_area services_pages">
            <div class="portfolio_filter portfolio_filter_2">
                <ul>
                    <li data-filter="*" class="active"><a href=""><i class="fa fa-file"
                                aria-hidden="true"></i>Send Money</a></li>
                </ul>
            </div>
            <div class="portfolio_item portfolio_2">
                ...
                <div class="single_facilities col-sm-10 invoice">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="tab-menu" onclick="notifyForm('{{ $email }}')"><a data-toggle="tab"
                                href="#menu2">Notification @if (isset($data))
                                    <span class="badge badge-danger">{{ $data['newnotification'] }}</span>
                                @else
                                    0
                                @endif
                            </a></li>
                        ...
                        <div id="home" class="tab-pane fade in active">
                            <div class="who_we_area">
                                ...
                                <div class="billingIns">
                                    ...
                                    {{-- <label for="orgInfo">Select Organizations</label>
                                        <select name="orgInfo" class="form-control billinginput_box" id="orgInfo">
                                            @if (count($clientInfo) > 0)
                                            <option value="">Select Organization</option>
                                            @foreach ($clientInfo as $orgs)
                                                <option value="{{ $orgs->user_id }}">{{ $orgs->business_name }}</option>
                                            @endforeach
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 disp-0">
                                                ...
                                                <select name="countryCode" id="countryCode"
                                                    class="form-control billinginput_box">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="orgInfo"
                                                    class="form-control billinginput_box" id="orgInfo"
                                                    placeholder="e.g 81702">

                                            </div>
                                            <div class="col-md-3">
                                                <label for="orgInfo">&nbsp;</label><br>
                                                <button class="btn btn-primary" onclick="checkDetail('send')">Confirm
                                                    details</button>
                            ...
                            <div class="who_we_area">
                                ...
                                <div class="billingIns">
                                    ...
                                    @if (Request::get('type') == base64_encode('international'))
                                        <div class="row">
                                            <div class="col-md-3 disp-0">
                                                <label for="bulkInfo">Country code</label>
                                                <select name="countryCode" id="countryCode"
                                                    class="form-control billinginput_box">
                                                    <option data-countryCode="DZ" value="213">Algeria (+213)</option>
                                                    <option data-countryCode="AD" value="376">Andorra (+376)</option>
                                            ...
                                            <div class="col-md-6">
                                                <label for="bulkInfo">Enter receivers account number</label>
                                                <input type="text" name="bulkInfo"
                                                    class="form-control billinginput_box" id="bulkInfo"
                                                    placeholder="e.g 81702">

                                            </div>
                                            <div class="col-md-3">
                                                <label for="bulkInfo">&nbsp;</label><br>
                                                <button class="btn btn-primary" onclick="checkDetail('check')">Confirm
                                                    details</button>
                                        ...
                                        <table class="table table-responsive table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>State</th>
                                                    <th>Country</th>
                                                    <th><button class='btn btn-Primary' id="btnGet" value="Get">Send Money to All</button></th>
                                                </tr>
                                            </thead>
                                            <tbody id="bulkRec">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th>State</th>
                                                    <th>Country</th>
                                                    <th><button class='btn btn-Primary' id="payment">Send Money to All</button></th>
                                                </tr>  
                                            </tfoot>
                                        </table>
                                            ...
                                            @if (Request::get('type') == 'international')
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="orgInfo"
                                                            class="form-control billinginput_box" id="recorgInfo"
                                                            placeholder="e.g 81702">

                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="recorgInfo">&nbsp;</label><br>
                                                        <button class="btn btn-primary"
                                                            onclick="checkDetail('rec')">Check details</button>
                        ...
                        <div id="menu3" class="tab-pane fade">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <input type="text" name="orgInfosearch" class="form-control billinginput_box"
                                        id="orgInfosearch" placeholder="John Doe">

                                </div>
                                <div class="col-md-3">
                                    <label for="orgInfo">&nbsp;</label><br>
                                    <button class="btn btn-primary" onclick="checkDetail('search')">Check
                                        details</button>
                                        ...
                                        @if (isset($data))
                                            @foreach ($data['allnotification'] as $notify)
                                                @if ($notify->notify == 1)
                                                    <tr>
                                                        <td><img
                                                                src="https://img.icons8.com/emoji/20/000000/check-box-with-check-emoji.png" />
                                                        </td>
                                                        <td>{{ $notify->activity }}<br><small style="color: navy;">
                                                                @if ($notify->action == 'Payment' || $notify->action == 'Wallet debit')
                                                                    <span style="color: red">Amount:
                                                                        {{ sprintf('%.2f', $notify->debit) }}</span>
                                                                @else
                                                                    <span style="color: green">Amount:
                                                                        {{ sprintf('%.2f', $notify->credit) }}</span>
                                                                @endif

                                                                <br>

                                                                {{ date('d-m-Y h:i A', strtotime($notify->created_at)) }}
                                                            </small></td>
                                                    </tr>
                                                @else
                                                    <tr>
                                                        <td><img
                                                                src="https://img.icons8.com/color/30/000000/push-notifications.png" />
                                                        </td>
                                                        <td style="font-weight: bold;">
                                                            {{ $notify->activity }}<br><small
