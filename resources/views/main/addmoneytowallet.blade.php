                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                <form role="form" action="#" method="POST" id="formElem">
                                    ...
                                    <div class="form-group"> <label for="amount">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-append"> <span class="input-group-text text-muted">
                                                    {{ $data['currencyCode']->currencySymbol }} </span> </div> <input
                                                type="number" min="0.00" step="0.01" name="amount" id="amount"
                                                class="form-control" required>

                                            <input type="hidden" name="currencyCode" class="form-control"
                                                id="curCurrency" value="{{ $data['currencyCode']->currencyCode }}"
                                                readonly>
                                            <input type="hidden" name="name" class="form-control" id="nameInput"
                                                value="{{ Auth::user()->name }}" readonly>
                                            <input type="hidden" name="phone" class="form-control" id="phoneInput"
                                                value="{{ Auth::user()->telephone }}" readonly>
                                            <input type="hidden" name="api_token" class="form-control"
                                                id="apiTokenInput" value="{{ Auth::user()->api_token }}" readonly>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <p style="color: red; font-weight: bold;"><input type="checkbox"
                                                    name="commission" id="commission"> Include fee</p>
                                    ...
                                    <div class="col-md-12 withCardGoogle disp-0">
                                        <center>
                                            ...
                                            <div id="moneris-google-pay" store-id="monca04155"
                                                web-merchant-key="55DAF4F744E7C36461258B79F750BC5D9D653C7D022FDB2DFC6A3309720C6D06">
                                            </div>
                                        </center>
                                    </div>
