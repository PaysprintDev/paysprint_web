            ...
            <div class="architecture_area services_pages">
                <div class="portfolio_item portfolio_2">
                   <div class="grid-sizer-2"></div>
                    ...
                    <li class="tab-menu active"><a data-toggle="tab" href="#home">Generate Invoice</a></li>
                    ...
                    <div id="home" class="tab-pane fade in active">
                        ...
                        <div class="who_we_area">
                            ...
                            <form method="POST" action="{{ route('generateInvoice') }}" id="invoice_form">
                            ...
                            <div class="billingIns">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="installment">Accept Installmental Payment <span class="importantfield">*</span></label>
                                        <select class="form-control billinginput_box" id="installment" name="installment" required>
                                            <option value="No">No</option>
                                            <option value="Yes">Yes</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="installment_limit">Kindly Set Installmental Limit</label>
                                        <select class="form-control billinginput_box" id="installment_limit" name="installment_limit" disabled="disabled">
                                            @for ($i = 1; $i <= 10; $i++)
                            ...
                            <div class="billingIns">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="invoice_generate">Generate Invoice Number <span class="importantfield">*</span></label>
                                        <select class="form-control billinginput_box" id="invoice_generate" name="invoice_generate" required>
                                    ...
                                    <div class="col-md-6">
                                        <label for="invoice_number">Invoice Number <span class="importantfield">*</span></label>
                                        <input type="text" name="invoice_number" id="invoice_number" class="form-control" readonly="readonly" required>
                                    </div>
                                </div>
                            ...
                            <div class="billingIns">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="transaction_date">Transaction Date <span class="importantfield">*</span></label>
                            ...
                            <div class="billingIns">
                                ...
                                <div class="row">
                                    ...
                                    @if($amountPay = \App\RentalQuote::where('maintenance_id', $maintdetail[0]->post_id)->get())

                                        @if (count($amountPay) > 0)
                                            <div class="col-md-6">
                                                <label for="amount">Amount Payable <span class="importantfield">*</span></label>
                                                <input type="number" name="amount" id="amount" class="form-control" value="{{ number_format($amountPay[0]->maintenance_price, 2) }}" readonly required>
                                            </div>
                                        @else
                                    ...
                                    <div class="col-md-6">
                                        <label for="payment_due_date">Payment Due Date <span class="importantfield">*</span></label>
                                        <input type="date" name="payment_due_date" id="payment_due_date" class="form-control" required>
                                    </div>
                                </div>
                            ...
                            <div class="billingIns">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="recurring_service">Recurring</label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="reminder_service">Reminder</label>
                                        <select name="reminder_service" class="form-control" id="reminder_service" disabled="disabled">
                                            @for ($i = 1; $i <= 31; $i++)
