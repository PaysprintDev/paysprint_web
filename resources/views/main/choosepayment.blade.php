                    ...
                    <div class="card-header">
                        <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                            ...
                            <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                <li class="nav-item" style="background-color: #007bff !important;"> <a data-toggle="pill" href="{{ route('home') }}" class="nav-link active" style="background-color: #007bff !important;"> <i class="fas fa-home"></i>
                                        Goto HomePage </a> </li>
                            </ul>
                        </div> <!-- End -->
                                    ...
                                    <div class="card" style="width: 100%;">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-center"><strong>24hrs - 48hrs Deposit
                                                    Period</strong></p>
                                            <a href="{{ route('Add Money') }}" class="btn btn-primary form-control">Continue</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card" style="width: 100%;">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-center"><strong>Within 24hrs Deposit
                                                    Period</strong></p>
                                            <a href="{{ route('partner payment') }}" class="btn btn-primary form-control">Continue</a>
                                        </div>
                                    </div>
                                </div>
                                @endif
