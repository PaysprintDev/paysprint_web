...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="single-widget d-flex align-items-center py-2">
                                        ...
                                        <h3 class="w-title gr-text-8 mb-0">Add money to Wallet from Debit or Credit Cards.
                                        </h3>
                                    </div>
                                </div>
                                <div class="col-md-8">
    ...
    <!-- CTA section -->
    <div class="cta-section pt-15 pt-lg-20 pb-5 pb-lg-5 bg-pattern pattern-7"
