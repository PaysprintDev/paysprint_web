                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input type="hidden" name="bank_id"
                                                            value="{{ $data['getthisBank']->id }}"
                                                            id="bank_id{{ $data['getthisBank']->id }}">
                                                        <a href="{{ route('Edit bank', $data['getthisBank']->id) }}"
                                                            title="Edit Bank Account"><i
                                                                class="far fa-edit text-secondary"></i></a>
                                                        <a href="javascript:void(0)" title="Delete Bank Account"
                                                            onclick="delhandShake('deletebank', '{{ $data['getthisBank']->id }}')"><i
                                                                class="far fa-trash-alt text-danger"></i></a>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <img
                                                            src="https://img.icons8.com/emoji/30/000000/bank-emoji.png" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <form action="#" method="POST" id="formElem">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @if (Auth::user()->country == 'Canada')
                                                        <select name="bankName" id="bankName" class="form-control"
                                                            required>
                                                            <option
                                                                data-tokens="{{ $data['getthisBank']->bankName }}"
                                                                value="{{ $data['getthisBank']->bankName }}">
                                                                {{ $data['getthisBank']->bankName }}</option>
                                                            <option data-tokens="RBC ROYAL BANK" value="RBC ROYAL BANK">
                                                                RBC ROYAL BANK</option>
                                                            <option data-tokens="TD CANADA TRUST"
                                                                value="TD CANADA TRUST">TD CANADA TRUST</option>
                                                            <option data-tokens="SCOTIABANK" value="SCOTIABANK">
                                                                SCOTIABANK</option>
                                                            <option data-tokens="DESJARDINS" value="DESJARDINS">
                                                                DESJARDINS</option>
                                                            <option data-tokens="NATIONAL BANK OF CANADA"
                                                                value="NATIONAL BANK OF CANADA">NATIONAL BANK OF CANADA
                                                            </option>
                                                            <option data-tokens="TANGERINE" value="TANGERINE">TANGERINE
                                                            </option>
                                                            <option data-tokens="SIMPLII FINANCIAL"
                                                                value="SIMPLII FINANCIAL">SIMPLII FINANCIAL</option>
                                                            <option
                                                                data-tokens="ENVISION FINANCIAL, A DIVISION OF FIRST WEST CU"
                                                                value="ENVISION FINANCIAL, A DIVISION OF FIRST WEST CU">
                                                                ENVISION FINANCIAL, A DIVISION OF FIRST WEST CU</option>
                                                            <option data-tokens="VANCITY" value="VANCITY">VANCITY
                                                            </option>
                                                            <option data-tokens="PROSPERA CREDIT UNION"
                                                                value="PROSPERA CREDIT UNION">PROSPERA CREDIT UNION
                                                            </option>
                                                    ...
                                                    @else
                                                        <input type="text" name="bankName" id="bankName"
                                                            class="form-control"
                                                            value="{{ $data['getthisBank']->bankName }}" required>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text text-muted"> <i
                                                                    class="fas fa-university"></i></span>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group"> <input type="text" name="transitNumber"
                                                        ...
                                                        value="{{ $data['getthisBank']->transitNumber }}" required>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text text-muted"> <i
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group"> <input type="text" name="branchCode"
                                                        ...
                                                        value="{{ $data['getthisBank']->branchCode }}" required>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text text-muted"> <i
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group"> <input type="text" name="accountName"
                                                        id="accountName" class="form-control"
                                                        value="{{ $data['getthisBank']->accountName }}" required>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text text-muted"> <i
                                                                class="fas fa-university"></i></span>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group"> <input type="text" name="accountNumber"
                                                        id="accountNumber" class="form-control"
                                                        value="{{ $data['getthisBank']->accountNumber }}" required>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text text-muted"> <i
                                                                class="fas fa-university"></i></span>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <button type="button" class="btn btn-primary btn-block"
                                                    onclick="handShake('editbank')" id="cardSubmit">Submit</button>
                                            </div>
