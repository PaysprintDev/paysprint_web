                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="alert alert-default">
                                            <a href="{{ route('request for refund') }}" type="button"
                                                class="btn btn-danger btn-block">Request For Refund To Wallet</a>
                                        </div>
                                    ...
                                    <nav>
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="nav-home" aria-selected="true">Wallet Statement <i
                                                    class="fas fa-circle text-secondary"></i></button>
                                            <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
                                                data-bs-target="#nav-profile" type="button" role="tab"
                                                aria-controls="nav-profile" aria-selected="false">Credit <i
                                                    class="fas fa-circle text-success"></i></button>
