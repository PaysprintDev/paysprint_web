    ...
    <div class="container py-5">
        ...
        <div class="row mb-4">
            <div class="col-lg-8 mx-auto text-center">
                <h1 class="display-4">Select Withdrawal Method</h1>
            </div>
        </div> <!-- End -->
        <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="card" style="width: 100%;">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-center"><strong>24hrs - 48hrs Withdrawal
                                                    Period</strong></p>
                                ...
                                <div class="col-md-6">
                                    <div class="card" style="width: 100%;">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-center"><strong>24hrs Withdrawal Period</strong>
                                            </p>
                                            <p class="card-text"></p>
                                            <a href="{{ route('partner withdrawal') }}"
                                                class="btn btn-primary form-control">Continue</a>
                                        </div>
                                    </div>
                                </div>
