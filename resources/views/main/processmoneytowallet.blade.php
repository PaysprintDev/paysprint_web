                    ...
                    <div class="card-header">
                        <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                            ...
                            <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                <li class="nav-item" onclick="window.history.back()"> <a data-toggle="pill" href="{{ route('payorganization') }}" class="nav-link active "> <i class="fas fa-home"></i> Go Back </a> </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                <form role="form" action="#" method="POST" id="paymentForm">
                                    ...
                                    <input type="hidden" name="orgpayname" id="orgpayname" value="{{ $data['name'] }}"> 

                                    <input type="hidden" name="orgpayemail" id="orgpayemail" value="{{ $data['email'] }}">
                                    ...
                                    <div class="card-footer"> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 withWallet">
                                                ...
                                                <button type="button" onclick="paymentOnline()" class="subscribe btn btn-primary btn-block shadow-sm sendmoneyBtn"> Make Payment </button>
