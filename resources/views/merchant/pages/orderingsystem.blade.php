...
<div class="page-body">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="font-weight: bold;">
                                        <h5> {{ Auth::user()->currencySymbol . '' .
                                            number_format(Auth::user()->escrow_balance, 2) }}
                                            {{-- <br>
                                            <span><a href="#" style="color:red; font-size:13px;">View History</a></span>
                                            --}}
                                        </h5>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="font-weight: bold;">
                                        <h5>{{ Auth::user()->currencySymbol . '' .
                                            number_format(Auth::user()->dispute_balance, 2) }}
                                            {{-- <br>
                                            <span><a href="#" style="color:red; font-size:13px;">View History</a></span>
                                            --}}
                                        </h5>
    ...
    <div class="container-fluid list-products">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <button class="nav-link" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button"
                    role="tab" aria-controls="nav-home" aria-selected="true">Products</button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ Auth::user()->currencySymbol . number_format($product->amount) }}
                                                    ...
                                                    <span
                                                        style="{{ $product->previousAmount > 0 ? 'text-decoration: line-through;' : '' }}">{{
                                                        $product->previousAmount > 0 ? Auth::user()->currencySymbol .
                                                        number_format($product->previousAmount) : '' }}</span>
                                                </td>
                                                </td>
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="editexampleModalLongTitle">Edit
                                                                product
                                                            </h5>
                                                            ...
                                                            <form action="{{ route('update product', $product->id) }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="float-end"><a href="javascript:void(0)"
                                                                            ...
                                                                            code</a></span>
                                                                    <input type="text" class="form-control productCode"
                                                                        name="productCode" aria-describedby="codeHelp"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="previousAmount">Previous
                                                                        Amount</label>
                                                                    <input type="number" min="0.00" step="0.01"
                                                                        name="previousAmount" class="form-control"
                                                                        id="previousAmount"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="category" id="category"
                                                                        ...
                                                                        <option value="{{ $itemCat->category }}" {{
                                                                            $product->category == $itemCat->category ?
                                                                            'selected' : '' }}>
                                                                            {{ $itemCat->category }}
                                                                        </option>
                                                                        @endforeach
                                                                ...
                                                                <div class="form-group specifycategory disp-0">
                                                                    <label for="specifyCategory">Specify
                                                                        Category</label>
                                                                    <input type="text" class="form-control"
                                                                        name="specifyCategory" id="specifyCategory"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" class="form-control" name="file"
                                                                        id="file" aria-describedby="imageHelp">
                                                                    <small id="stockHelp"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control store_description"
                                                                        name="description"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ $orders->image }}" target="_blank"><img
                                                                class="img-fluid img-30" src="{{ $orders->image }}"
                                                                alt="{{ $orders->id }}" /></a>
                                                    </td>
                                                    ...
                                                    <td>{{ Auth::user()->currencySymbol .
                                                        number_format($orders->quantity * $orders->amount, 2) }}
                                                    </td>
                                        ...
                                        <table class="table table-bordernone display" id="basic-3">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $discounts->valueType == 'Fixed' ?
                                                        Auth::user()->currencySymbol . $discounts->discountAmount :
                                                    ...
                                                    <td>
                                                        ...
                                                        <form
                                                            ...
                                                            method="post" id="formDiscount{{ $discounts->discountId }}">
                                                            @csrf
                                                        </form>
                                                ...
                                                <div class="modal fade"
                                                    ...
                                                    <div class="modal-dialog modal-lg modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="editexampleModalLongTitle">
                                                                    Edit
                                                                    discount
                                                                </h5>
                                    ...
                                    <div class="card">
                                        <div class="product-box">
                                            <div class="product-img">
                                                <img class="img-fluid" src="{{ $categories->image }}" alt=""
                                            ...
                                            <div class="modal fade" id="catexampleModalCenter{{ $categories->id }}">
                                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <div class="product-box row">
                                                                ...
                                                                <div class="product-details col-lg-6 text-start">
                                                                    ...
                                                                    <div class="product-price">
                                                                        {{ Auth::user()->currencySymbol .
                                                                        $categories->amount }}
                                                                        <del>{{ Auth::user()->currencySymbol .
                                                                            $categories->previousAmount }}</del>
                                                                    </div>
                                            ...
                                            <div class="product-details">
                                                ...
                                                <div class="product-price">
                                                    ...
                                                    <del>{{ Auth::user()->currencySymbol . $categories->previousAmount
                                                        }}</del>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header" style="background-color: #F4F6F8">
                                        ...
                                        <a href="{{ route('home') . '/shop/' . Auth::user()->businessname }}"
                                            target="_blank" class="text-primary" style="font-weight: bold;">{{
                                            route('home') . '/shop/' . Auth::user()->businessname }}
                                            <span class="svg-icon"><svg width="10" height="10" viewBox="0 0 10 10"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <a href="{{ route('merchant service setup') }}" class="btn btn-success"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" value=""
                                                        id="flexCheckDefault" {{ $data['storepickup']> 0 ? 'checked
                                                    disabled' : '' }}>
        ...
        '" class="text-primary">View/Add
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value=""
                                                        id="flexCheckChecked" {{ $data['deliverypickup']> 0 ? 'checked
                                                    disabled' : '' }}>
                                        ...
                                        <div class="modal fade" id="addProductTax">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('store product tax') }}" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="taxName"
                                                                    id="taxName" aria-describedby="taxNameHelp"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" min="0.00" step="0.01"
                                                                    class="form-control" name="taxValue" id="taxValue"
                                                                    aria-describedby="taxValueHelp"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('store product') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="amount">New Amount</label>
                            <input type="number" min="0.00" step="0.01" name="amount" class="form-control" id="amount"
                        ...
                        <div class="form-group">
                            <label for="description">Description</label>
                            <textarea class="form-control store_description" name="description"
                        ...
                        <div class="form-group">
                            <label for="stock">Product Image</label>
                            <input type="file" class="form-control" name="file" id="file" aria-describedby="imageHelp"
                                required>
                    ...
                    <form action="{{ route('store discount') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="code">Discount code </label> <span class="float-end"><a
                                    href="javascript:void(0)" class="text-primary" onclick="generateDiscountCode()">Auto
                                    Generate
                                    code</a></span>
                                ...
                                <div class="form-group"> <label for="amount">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-append"> <span
                                                class="input-group-text text-muted symbolText">
                                                {{ Auth::user()->currencySymbol }} </span> </div> <input type="number"
                                            min="0.00" step="0.01" name="amount" id="discountAmount"
                ...
                <div class="modal-body">
                    <form action="{{ route('setup estore') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="advertSectionImage[]" id="advertSectionImage"
                                aria-describedby="advertSectionImageHelp" multiple>
