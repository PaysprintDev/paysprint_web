                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="#" method="post" enctype="multipart/form">
                                    ...
                                    <div class="mb-3">
                                        <label style="font-weight: bold;" for="businessLogo" class="form-label">Select
                                            background
                                            drop</label>
                                        <div id="emailHelp" class="form-text">Select your preferred background drop.</div>
                                    ...
                                    <div class="mb-3">
                                        <label style="font-weight: bold;" for="youtubeLink" class="form-label">Embed Youtube
                                    ...
                                    <div class="mb-3">
                                        <label style="font-weight: bold;" for="businessWebsite" class="form-label">Business
                                ...
                                <form action="#" method="post" enctype="multipart/form">
                                    ...
                                    <div class="mb-3">
                                        <label style="font-weight: bold;" for="businessDescription" class="form-label">Brief
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="legendQuestionThree" id="legendQuestionThree"
                                                    class="form-control" aria-describedby="legendQuestionThree">
                                    ...
                                    <br>
                                    <div class="mb-3">
                                        <label style="font-weight: bold;" for="businessLogo" class="form-label">Important
                                            Company Image (Optional)</label>
                                        <input type="file" name="businessLogo" id="businessLogo" class="form-control"
                                            aria-describedby="emailHelp">
                                        <div id="emailHelp" class="form-text">If there is any important official image.
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" name="businessServiceOne" id="businessServiceOne"
                                                    class="form-control" aria-describedby="businessServiceOne">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" name="businessServiceTwo" id="businessServiceTwo"
                                                    class="form-control" aria-describedby="businessServiceTwo">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" name="businessServiceFour" id="businessServiceFour"
                                                    class="form-control" aria-describedby="businessServiceFour">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" name="businessServiceFive" id="businessServiceFive"
                                                    class="form-control" aria-describedby="businessServiceFive">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" name="businessServiceSix" id="businessServiceSix"
                                                    class="form-control" aria-describedby="businessServiceSix">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="pricePlanAmountOne" id="pricePlanAmountOne"
                                                    class="form-control" aria-describedby="pricePlanAmountOne">
                                                <br />
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <label style="font-weight: bold;" for="pricePlanAmountTwo"
                                                    class="form-label">Plan Amount</label>
                                                <input type="text" name="pricePlanAmountTwo" id="pricePlanAmountTwo"
                                                    class="form-control" aria-describedby="pricePlanAmountTwo">
                                                <br />
