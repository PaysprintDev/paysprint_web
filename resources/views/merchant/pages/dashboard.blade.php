                    ...
                    <div class="row">
                        ...
                        <div class="d-flex flex-row justify-content-start">
                            ...
                            <div class="col-md-4 mb-3 addMoney">
                                ...
                                <a style="font-size: 14px; font-weight: bold;" type="button"
                                    href="{{ route('Add Money') }}" class="btn btn-info btn-block">Add Money <i
                                        class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>

                            <div class="col-md-4 mb-3 sendMoney">
                                <a style="font-size: 14px; font-weight: bold;" type="button"
                                    href="{{ url('payorganization?type=' . base64_encode('local')) }}"
                            ...
                            @if (Auth::check() == true)
                                ...
                                @if ($imt = \App\AllCountries::where('name', Auth::user()->country)->where('imt', 'true')->first())
                                    ...
                                    @else
                                        ...
                                        <div class="col-md-4 mb-3 sendMoney">
                                            <a style="font-size: 14px; font-weight: bold;" type="button"
                                                href="javascript:void()" onclick="comingSoon()"
                                                class="btn btn-primary btn-block">Intl. Trans. <i class="fa fa-paper-plane"
                                                    aria-hidden="true"></i></a>
                                        </div>
                            ...
                            @else
                                <div class="col-md-4 mb-3 sendMoney">
                                    <a style="font-size: 14px; font-weight: bold;" type="button" href="javascript:void()"
                                        onclick="comingSoon()" class="btn btn-primary btn-block">Intl. Trans. <i
                        ...
                        <div class="d-flex flex-row justify-content-center">
                            ...
                            <div class="col-md-4 mb-3 withdrawMoney">
                                <a style="font-size: 14px; font-weight: bold;" type="button"
                                    href="{{ route('Withdraw Money') }}" class="btn btn-success btn-block">Withdraw
                            ...
                            <div class="col-md-4 mb-3 payinvoiceMoney">
                                <a style="font-size: 14px; font-weight: bold;" type="button" href="{{ route('invoice') }}"
                                    class="btn btn-danger btn-block ">Invoice <i class="fa fa-credit-card"></i></a>
                            </div>
                            ...
                            <div class="col-md-4 mb-3 payutilityMoney">
                                ...
                                @if (Auth::user()->country == 'Nigeria')
                                    <a style="font-size: 14px; font-weight: bold; background: black; color: white;"
                                        type="button" href="{{ route('utility bills') }}"
                                        class="btn btn-info btn-block">Utility
                        ...
                        <div class="col-xl-12 col-md-6 box-col-6 des-xl-50">
                            <div class="card profile-greeting">
                                ...
                                <div class="card-body text-center p-t-0">
                                    ...
                                    <a type="button" class="btn btn-light" href="{{ route('merchant profile') }}">Update
                                        Profile</a>
                                </div>
                                <div class="confetti">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a href="javascript:void()"
                                                ...
                                                style="color: navy; font-weight: 700;"> Click to activate Manage Rental
                                                Property, MRP</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a href="javascript:void()"
                                                ...
                                                style="color: navy; font-weight: 700;">Click to Access MRP as a Service
                                                Provider</a>
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <a href="#" style="color: navy; font-weight: 700;">Learn more about trading
                                                    on PaySprint</a>
