                            ...
                            <div class="card income-card card-primary">
                                <div class="card-body text-center">
                                        ...
                                        @if ($data['clientInfo']->accountMode != 'test')
                                            ...
                                            @if (Auth::user()->payment_link_access == 1 && $datediff > 0)
                                                ...
                                                <p class="text-success" style="font-weight: bold;">Link expires: <br>
                                                    <span class="text-danger"
                                                        style="font-weight: bold;">{{ date('d-M-Y h:i a', strtotime(Auth::user()->payment_link_expiry)) }}</span>
                                                </p>

                                                <a href="#"
                                                    style="color: navy; font-weight: 700; text-align: left;">Click and Share
                                            ...
                                            @else
                                                ...
                                                <p class="alert alert-danger text-white" style="cursor: pointer"
                                                    onclick="getMyPaymentLink('{{ Auth::user()->id }}')"><strong>Generate
                                                ...
                                                <button type="button" class="btn btn-primary disp-0" data-bs-toggle="modal"
                                                    ...
                                                    id="paymentLinkModal{{ Auth::user()->id }}">
                                                    Launch demo modal
                                                </button>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="text-align: left">
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <span class="text-danger"
                                                                        style="font-weight: bold">penalty of
                                                                        $50.00</span> or equivalent in local currency.
                                                                </p>

                                                                <p>

                                                                <form action="{{ route('request payment link') }}"
                                                                    method="POST" id="myPaymentLinkUp">
                                                                    @csrf
                                                                    <input type="hidden" name="id" id="myId"
                                                                        value="{{ Auth::user()->id }}">
                                                                </form>

                                                                <input type="checkbox" name="paylink_checkbox"
                                                                    id="paylink_checkbox"
                                    ...
                                    @else
                                        <!-- ShareThis BEGIN -->
                                        <p class="alert alert-danger text-white" style="cursor: pointer"
                                            onclick="getMyPaymentLink('{{ Auth::user()->id }}')"><strong>Generate Payment
                                                Link:</strong></p>
                                ...
                                @if ($payout = \App\PayoutAgent::where('user_id', Auth::user()->ref_code)->first())
                                   ...
                                   <div class="d-flex flex-row justify-content-center">
                                        <div class="col-md-12 mb-3">
                                            <a type="button" href="{{ route('my payout record') }}"
                                                class="btn btn-success btn-block" style="width: 100%;">Visit My Payout Record <i class="fa fa-money" aria-hidden="true"></i>
                                            </a>
                                        </div>
