                ...
                <div class="col-xl-5 box-col-12 des-xl-100">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                            <div class="card income-card card-primary">
                                <div class="card-body text-center">
                                    ...
                                    <h5>85,049</h5>
                                    <p>Wallet Balance</p><a class="btn-arrow arrow-primary" href="javascript:void(0)"><i
                        ...
                        <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                            <div class="card income-card card-secondary">
                                <div class="card-body text-center">
                                    ...
                                    <h5>14</h5>
                                    <p>Paid Invoice</p><a class="btn-arrow arrow-secondary" href="javascript:void(0)"><i
                        ...
                        <div class="col-md-4 mb-3 addMoney">
                            ...
                            <a style="font-size: 14px; font-weight: bold;" type="button" href="#"
                                class="btn btn-info btn-block">Add Money <i class="fa fa-plus"
                                    aria-hidden="true"></i></a>
                        </div>

                        <div class="col-md-4 mb-3 sendMoney">
                            <a style="font-size: 14px; font-weight: bold;" type="button" href="#"
                                class="btn btn-warning btn-block">Local Trans. <i class="fa fa-paper-plane"
                                    aria-hidden="true"></i></a>
                        </div>
                        ...
                        <div class="col-md-4 mb-3 withdrawMoney">
                            <a style="font-size: 14px; font-weight: bold;" type="button" href="#"
                                class="btn btn-success btn-block">Withdrawal <i class="fa fa-credit-card"></i></a>
                        </div>

                        <div class="col-md-4 mb-3 payinvoiceMoney">
                            <a style="font-size: 14px; font-weight: bold;" type="button" href="#"
                                class="btn btn-danger btn-block ">Pay Invoice <i class="fa fa-credit-card"></i></a>
                        </div>

                        <div class="col-md-4 mb-3 payutilityMoney">


                            <a style="font-size: 14px; font-weight: bold; background: black; color: white;" type="button"
                                href="#" class="btn btn-info btn-block">Utility
                                Bill <i class="fa fa-credit-card"></i></a>
                        ...
                        <div class="col-xl-12 col-md-6 box-col-6 des-xl-50">
                            <div class="card profile-greeting">
                                ...
                                <div class="card-body text-center p-t-0">
                                    <h3 class="font-light">Pro-filr LTD!</h3>
                                    <p>No 14, Samuel Awoniyi Street, Opebi. Ikeja. Lagos State</p>
                                    <a type="button" class="btn btn-light" href="{{ route('profile') }}">Update
                                        Profile</a>
                                </div>
                                <div class="confetti">
                            ...
                            <div class="header-top d-sm-flex align-items-center">
                                ...
                                <div class="center-content">
                                    <p class="d-sm-flex align-items-center"><span
                                            ...
                                            class="toprightarrow-primary fa fa-arrow-up m-r-10"></i>86% More than last
                                        year</p>
                                </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="media"><img class="img-fluid rounded-circle"
                                                            ...
                                                            <div class="media-body"><a href="#"><span>Fee to J18 HEIR
                                                                        INVESTMENTS CORP</span></a></div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p>16 August</p>
                                                    ...
                                                    <td><img class="img-fluid" {{-- src=" {{ asset('assets/images/dashboard/icons8-invoice-30.png') }}"lt="" --}}
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media"><img class="img-fluid rounded-circle"
                                                                src=" {{ asset('assets/images/dashboard/icons8-invoice-30.png') }}"
                                                                ng') }}" alt="" data-original-title="" title="">
                                                            <div class="media-body"><a href="#"><span>Sony Brand
                                                    ...
                                                    <td><img class="img-fluid" {{-- src=" {{ asset('assets/images/dashboard/icons8-invoice-30.png') }}" --}} alt=""
                                                            data-original-title="" title=""></td>
                                                    <td>
                                                        <p>$548526</p>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media"><img class="img-fluid rounded-circle"
                                                                src=" {{ asset('assets/images/dashboard/icons8-invoice-30.png') }}"
                                                                alt="" data-original-title="" title="">
                                                            <div class="media-body"><a href="#"><span>Being Boy
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media"><img class="img-fluid rounded-circle"
                                                                src=" {{ asset('assets/images/dashboard/icons8-invoice-30.png') }}"
                                                                alt="" data-original-title="" title="">
                                                            <div class="media-body"><a href="#"><span>Fees to J18 HEIR
                                                                        INVESTMENTSx CORP</span></a></div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p>16 August</p>
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body"><span>Segun Adebiyi</span>
                                                <p>PS_2021102128</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td colspan="2">$5,000</td>
                                    <td><a type="button" class="btn btn-outline-success " href="">View
                                            Details</a></td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body"><span>Bambo Adenuga</span>
                                                <p>PS_2021092907</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body"><span>Shalom Adebiyi</span>
                                                <p>PS_2021092715</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body"><span>Adebambo Adenuga</span>
                                                <p>PS_2021042446</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="media-body"><span>Adesanya Samuel</span>
                                                <p>PS_2021092907</p>
                                            </div>
                                        </div>
                                    </td>
