            ...
            <div class="col-xl-5 box-col-12 des-xl-100">
                ...
                <div class="row">
                    ...
                    <div class="d-flex flex-row justify-content-start">
                        ...
                        @if (isset($imt))
                        <div class="col-md-6 mb-3 sendMoney">
                            <a type="button" href="javascript:void()" class="btn btn-primary btn-block" style="width: 100%;">International
                                money
                    ...
                    <div class="d-flex flex-row justify-content-center">
                        <div class="col-md-12 mb-3">
                            <a type="button" href="{{ route('my payout record') }}" class="btn btn-success btn-block" style="width: 100%;">Visit My Payout Record <i class="fa fa-money" aria-hidden="true"></i>
                            </a>
                        </div>
                                ...
                                <div class="wrapper option-1 option-1-1">
                                    <ol class="c-stepper">
                                        ...
                                        <li class="c-stepper__item {{ $data['myplan'] ? 'c-stepper__item__active' : '' }}">
                                            ...
                                            <p class="c-stepper__desc" style="font-size:20px; font-weight:bold; color:red;">
                                                {{ $data['myplan']->plan }}
                                            </p>
                                        </li>
                                    </ol>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $payInv->invoice_no }} {!! $countryBase != Auth::user()->country
                                        ? '<img src="https://img.icons8.com/color/30/000000/around-the-globe.png" />'
                                        : '' !!}</td>
