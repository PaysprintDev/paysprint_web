                    ...
                    <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                        <div class="card income-card card-primary">
                            <div class="card-body text-center">
                                ...
                                <!-- ShareThis BEGIN -->
                                <p class="alert alert-danger text-white" style="cursor: pointer" onclick="getMyPaymentLink('{{ Auth::user()->id }}')"><strong>Generate Payment Link:</strong></p>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" style="text-align: left">
                                                <p>
                                                    PaySprint Merchant Payment link is a fast and quick method to accept payment from customers into the merchant account.
                                                </p>
                                                <p>
                                                    As a User, you confirm that the customers to whom the link is shared is a verified customer and you
                                                    agree and accept to be responsible for any charge back that may result for payment being returned.
                                                </p>
                                                <p>
                                                    You also accept that PaySprint should debit your merchant account with the chargeback amount along with <span class="text-danger" style="font-weight: bold">penalty of
                                                ...
                                                <input type="checkbox" name="paylink_checkbox" id="paylink_checkbox" style="width: 20px; height: 20px; margin-top: 3px;"> <span style="font-weight: bold; color: navy;">Accept terms and conditions before proceeding</span>
                                                </p>
                                            </div>
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Generate Payment Link.</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body" style="text-align: left">
                                                <p>
                                                    Payment Link would be available when your merchant account is fully verified. Kindly complete your merchant account verification by uploading the business documents
                                                </p>
                                            </div>
                        ...
                        <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                            <div class="card income-card card-primary">
                                <div class="card-body text-center">
                                    ...
                                    @else
                                                    ...
                                                    <!-- Button trigger modal -->
                                                            ...
                                                            <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-body" style="text-align: left">
                                                                    <p>
                                                                        Payment Link would be available when your merchant account is on LIVE mode
                                                                    </p>
                                                                </div>
                                    ...
                                    @endif
>>>>>>> 2eb71ce44e520c0e465d1d7a3f0b9eb56b48d605
                    ...
                    <div class="d-flex flex-row justify-content-start">
                        ...
                        <div class="col-md-6 mb-3 addMoney">
                            ...
                            <a type="button" href="javascript:void()" class="btn btn-info btn-block" style="width: 100%;">Top up
                                wallet <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>

                        <div class="col-md-6 mb-3 withdrawMoney">
                            <a type="button" href="javascript:void()" class="btn btn-success btn-block" style="width: 100%;">Withdraw
                    ...
                    <div class="d-flex flex-row justify-content-start">
                        ...
                        <div class="col-md-6 mb-3 sendMoney">
                            <a type="button" href="javascript:void()" class="btn btn-warning btn-block" style="width: 100%;">Local money transfer <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                        ...
                        @if (isset($imt))
                        <div class="col-md-6 mb-3 sendMoney">
                            <a type="button" href="javascript:void()" class="btn btn-primary btn-block" style="width: 100%;">International money
                                transfer <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                        @else
                        <div class="col-md-6 mb-3 sendMoney">
                            <a type="button" href="javascript:void()" onclick="comingSoon()" class="btn btn-primary btn-block" style="width: 100%;">International
                                money
                                transfer <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                        @endif
                        @else
                        <div class="col-md-6 mb-3 sendMoney">
                            <a type="button" href="javascript:void()" onclick="comingSoon()" class="btn btn-primary btn-block" style="width: 100%;">International money
                                transfer <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                        @endif
                        @else
                    ...
                    <div class="d-flex flex-row justify-content-center">
                        ...
                        <div class="col-md-6 mb-3 payinvoiceMoney">
                            <a type="button" href="javascript:void()" class="btn btn-danger btn-block" style="width: 100%;">Create
                        ...
                        <div class="col-md-6 mb-3 payutilityMoney">
                            ...
                            <a type="button" href="javascript:void()" class="btn btn-info btn-block" style="width: 100%;">Pay Utility
                    ...
                    <div class="d-flex flex-row justify-content-start">
                        ...
                        <div class="col-md-6 mb-3 addMoney">
                            ...
                            <a type="button" href="{{ route('Add Money') }}" class="btn btn-info btn-block" style="width: 100%;">Top up
                                wallet <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>

                        <div class="col-md-6 mb-3 withdrawMoney">
                            <a type="button" href="{{ route('Withdraw Money') }}" class="btn btn-success btn-block" style="width: 100%;">Withdraw
                                Money to Bank <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    ...
                    <div class="d-flex flex-row justify-content-start">
                        ...
                        <div class="col-md-6 mb-3 sendMoney">
                            <a type="button" href="{{ url('payorganization?type=' . base64_encode('local')) }}" class="btn btn-warning btn-block" style="width: 100%;">Local money transfer <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                        ...
                        @if (isset($imt))
                        <div class="col-md-6 mb-3 sendMoney">
                            <a type="button" href="{{ url('payorganization?type=' . base64_encode('international')) }}" class="btn btn-primary btn-block" style="width: 100%;">International
                                money
                                transfer <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                        @else
                    ...
                    <div class="d-flex flex-row justify-content-center">
                        ...
                        <div class="col-md-6 mb-3 payinvoiceMoney">
                            <a type="button" href="{{ route('create single invoice') }}" class="btn btn-danger btn-block" style="width: 100%;">Create
                                Invoice <i class="fa fa-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 mb-3 payutilityMoney">
                            ...
                            @if (Auth::user()->country == 'Nigeria')
                            <a type="button" href="{{ route('utility bills') }}" class="btn btn-info btn-block" style="width: 100%;">Pay Utility
                                Bill <i class="fa fa-plus" aria-hidden="true"></i></a>
                            @else
                            <a type="button" href="{{ route('select utility bills country', 'country=' . Auth::user()->country) }}" class="btn btn-info btn-block" style="width: 100%;">Pay Utility
                                Bill <i class="fa fa-plus" aria-hidden="true"></i></a>
                            @endif
                    ...
                    <div class="col-xl-12 col-md-6 box-col-6 des-xl-50">
                        <div class="card profile-greeting">
                            ...
                            <div class="card-body text-center p-t-0">
                                ...
                                <a type="button" class="btn btn-light mb-3" href="{{ route('merchant profile') }}">Update
                                    Profile</a>
                            ...
                            <div class="confetti">
                                ...
                                <div class="code-box-copy">
                                    <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#profile-greeting" title="Copy"><i class="icofont icofont-copy-alt" href=""></i></button>
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a href="javascript:void()" onclick="whatyouOffer('{{ Auth::user()->email }}')" style="color: navy; font-weight: 700;"> Click to activate Manage
                                            Rental
                                            Property, MRP</a>
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a href="javascript:void()" onclick="viewConsultant('{{ Auth::user()->email }}')" style="color: navy; font-weight: 700;">Click to Access MRP as a
                                            Service
                                            Provider</a>
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a type="button" class="btn btn-success" href="{{ route('paysprint currency exchange') }}">PaySprint
                                            FX</a>
                        ...
                        <div class="header-top d-sm-flex align-items-center">
                            ...
                            <div class="center-content">
                                <p class="d-sm-flex align-items-center">
                                    {{-- <span
                                            class="font-primary m-r-10 f-w-700">{{ Auth::user()->currencySymbol . '' . number_format($data['totalPaidInvoice'], 2) }}</span><i class="toprightarrow-primary fa fa-arrow-up m-r-10"></i> --}}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="wrapper option-1 option-1-1">
                                        <ol class="c-stepper">
                                            <li class="c-stepper__item {{ isset($data['merchantstatus']) ? 'c-stepper__item__active' : ''}}">
    ...
    <div class="card mb-3" style="max-width: 100%; cursor: pointer;" onclick="location.href=`{{ route('merchant profile') }}`">
        <div class="card-body border border-danger">

            <h5 class="card-title"> <img src="https://img.icons8.com/external-xnimrodx-blue-xnimrodx/50/000000/external-verify-bill-and-payment-method-xnimrodx-blue-xnimrodx.png" />
    ...
    <div class="card mb-3" style="max-width: 100%; cursor: pointer;" onclick="location.href=`{{ route('set up tax') }}`">
        <div class="card-body border border-danger">

            <h5 class="card-title"> <img src="https://img.icons8.com/external-kiranshastry-lineal-color-kiranshastry/50/000000/external-file-interface-kiranshastry-lineal-color-kiranshastry-1.png" />
    ...
    <div class="card mb-3" style="max-width: 100%; cursor: pointer;" onclick="location.href=`{{ route('payment gateway') }}`">
        <div class="card-body border border-danger">

            <h5 class="card-title"> <img src="https://img.icons8.com/external-vitaliy-gorbachev-lineal-color-vitaly-gorbachev/50/000000/external-bank-business-vitaliy-gorbachev-lineal-color-vitaly-gorbachev.png" />
        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link btn btn-default" type="button" role="tab" onclick="location.href='{{ route('getwalletStatement') }}'">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordernone table-striped invoicetable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media"><img class="img-fluid rounded-circle" src=" {{ asset('merchantassets/assets/images/dashboard/icons8-invoice-30.png') }}" alt="" data-original-title="" title="">
                                                <div class="media-body"><a href="#"><span>{{ $payInvoices->transactionid }}</span></a>
                                                </div>
                                            </div>
                            ...
                            <table class="table table-bordernone invoicetable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media"><img class="img-fluid rounded-circle" src=" {{ asset('merchantassets/assets/images/dashboard/icons8-invoice-30.png') }}" alt="" data-original-title="" title="">
                                                <div class="media-body"><a href="#"><span>{{ date('d/M/Y', strtotime($invoiceLinkImports->created_at)) }}</span></a>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ route('link customer', $invoiceLinkImports->id) }}" type="button" class="btn btn-primary text-white">details</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @else
                    ...
                    <table class="table table-bordernone invoicetable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('customer', $invoiceImports->id) }}" type="button" class="btn btn-primary text-white">details</a>
                                </td>
                            </tr>
                            @endforeach
                            @else
