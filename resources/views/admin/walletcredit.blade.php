					...
					<div class="box-header">
						...
						<div class="row">
							<div class="col-md-12 mt-3">
								<form action="{{route('wallet account credit')}}" method="get">
									@csrf
									...
									<tr>
										...
										<td>
											...
											<button type="button" class="btn btn-success" data-toggle="modal"
												...
												Credit Security Deposit Wallet
											</button>
										</td>
										<!-- Modal -->
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													<div class="modal-header">
														<h5 class="modal-title" id="exampleModalLabel">Wallet Credit
														</h5>
													...
													<div class="modal-body">
														<form action="{{route('submit wallet credit')}}" method="post">
															@csrf
															<div class="col-md-12">
															...
															<div class="col-md-12 mt-4 mb-3">
																<div class="form-group">
																	...
																	<input type="text" name="credit_amount"
																		class="form-control"
																		placeholder="Enter amount to credit Customer">
																</div>
															</div>
															<div class="col-md-12 mt-4 mb-3">
																<div class="form-group">
																	<label>Reasons for Wallet Credit</label>
																	<input type="text" name="credit_reason"
																		class="form-control"
																		placeholder="Please enter reason for wallet credit">
																</div>
															</div>
										...
										<div class="modal fade" id="exampleModal2{{$data['details']->id}}" tabindex="-1"
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-body">
														<form action="{{route('submit security wallet credit')}}"
															method="post">
															@csrf
															<div class="col-md-12">
																<div class="form-group">
															...
															<div class="col-md-12 mt-4 mb-3">
																<div class="form-group">
																	...
																	<input type="text" name="credit_amount"
																		class="form-control"
																		placeholder="Enter amount to credit merchant security wallet">
																</div>
															</div>
															<div class="col-md-12 mt-4 mb-3">
																<div class="form-group">
																	<label>Reasons for Security Wallet Credit</label>
																	<input type="text" name="credit_reason"
																		class="form-control"
																		placeholder="Please enter reason for security wallet credit">
																</div>
															</div>
															<input type="hidden" name="user_id"
																value="{{$data['details']->id}}">
