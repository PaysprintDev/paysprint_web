                                    ...
                                    @if (count($allusers) > 0)
                                        ...
                                        @foreach ($allusers as $data)
                                            <tr>
                                                ...
                                                @if ($allusersdata = \App\User::where('plan', 'classic')->where('accountType', 'Individual')->where('country', $data->country)->count())
                                                    <td>{{ $allusersdata }}</td>
                                                @endif
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('upgradedconsumer', 'country=' . $data->country) }}"
