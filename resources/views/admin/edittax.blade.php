          ...
          <div class="row">
            ...
            <form action="#" method="POST" id="formElem">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-success">
                                ...
                                <input type="hidden" name="id" value="{{ $data['getthisTax']->id }}">
                                <input type="text" class="form-control" name="name" id="name" value="{{ $data['getthisTax']->name }}" placeholder="Name Of Tax">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group has-success">
                                ...
                                <input type="number" min="0.00" step="0.01" class="form-control" name="rate" id="rate" value="{{ $data['getthisTax']->rate }}" placeholder="Tax Rate (%)">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group has-success">
                                <label class="control-label" for="inputSuccess"> Name of Agency</label>
                                <input type="text" class="form-control" name="agency" id="agency" value="{{ $data['getthisTax']->agency }}" placeholder="Name of Agency">
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-footer">
                  <button type="button" class="btn btn-primary btn-block" onclick="handShake('edittax')" id="cardSubmit">Submit</button>
                </div>
              </form>
