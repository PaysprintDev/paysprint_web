        ...
        <section class="content-header">
            <h1>
                @if (Request::get('country') != null)
                    All Suspended Users In {{ Request::get('country') }}
                @else
                    All Suspended Users
                @endif
            </h1>
                        ...
                        <div class="box-body table table-responsive">
                            ...
                            <table class="table table-bordered table-striped" id="example3">
                                ...
                                <tbody>
                                    ...
                                    @if ($allusersdata = \App\User::where('flagged', 1)->where('country', Request::get('country'))->get())
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <a href="javascript:void()"
                                                            onclick="openAccount('{{ $datainfo->id }}')"
                                                            class="text-success"><i class="fas fa-lock-open text-success"
                                                                style="font-size: 20px;" title="Open Account"></i> <img
                                                                class="spinopen{{ $datainfo->id }} disp-0"
