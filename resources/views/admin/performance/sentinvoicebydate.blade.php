  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <li><a href="{{ route('Admin') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">Sent Invoice</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <form action="{{ route('sent invoice by date') }}" method="get">
                @csrf
                <div class="row">
                  <div class="col-md-6">
            ...
            <div class="box-body">
              <table id="example3" class="table table-bordered table-striped">
                ...
                <tbody id="statementtab">
                    @if (count($data['getsentInvoice']) > 0)
                    <?php $i = 1; $totalPaid = 0; $remtoPay = 0; $totalinv = 0;?>
                        @foreach ($data['getsentInvoice'] as $items)
                        <tr>
                            <td>{{ $i++ }}</td>
                    ...
                    @else
                    <tr>
                        <td colspan="9" align="center">No sent invoice record</td>
                    </tr>
                    @endif
                </tbody>
