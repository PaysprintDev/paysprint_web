        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <form action="{{ route('paid invoice by date') }}" method="get">
                @csrf
                <div class="row">
                  <div class="col-md-6">
            ...
            <div class="box-body table-responsive">
              <table id="example3" class="table table-bordered table-striped">
                ...
                <tbody id="statementtab">
                    @if (count($data['getpaidInvoice']) > 0)
                    <?php $i = 1; $totalPaid = 0; $remtoPay = 0; $totalinv = 0;?>
                        @foreach ($data['getpaidInvoice'] as $items)
                        <tr>
                            <td>{{ $i++ }}</td>
                            ...
                            <td style="{{ ($items->payment_status == 1) ? 'color: green; font-weight: bold;' : 'color: darkorange; font-weight: bold;' }}">{{ ($items->payment_status == 1) ? "Fully Paid" : "Partly Paid" }}</td>
                    ...
                    @else
                    <tr>
                        <td colspan="10" align="center">No paid invoice record</td>
                    </tr>
                    @endif
                </tbody>
