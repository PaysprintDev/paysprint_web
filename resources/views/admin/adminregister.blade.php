        ...
        <div class="login-box-body">
            ...
            <form action="#" method="post">
                ...
                <div class="form-group has-feedback">
                    ...
                    <input type="text" name="business_telephone" id="business_telephone" class="form-control"
                ...
                <div class="form-group has-feedback disp-0">
                    ...
                    <input type="text" name="business_address" id="business_address" class="form-control"
                        placeholder="Business Street Number & Name*" value="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 disp-0">
                            ...
                            <input type="text" name="business_zip_code" id="business_zip_code" class="form-control"
                                placeholder="Postal/Zip Code" value="">
                        </div>
                        <!-- /.col -->
                ...
                <div class="form-group has-feedback otherservice disp-0">
                    ...
                    <input type="text" name="other_type_of_service" id="other_type_of_service" class="form-control"
                ...
                <div class="form-group has-feedback">
                    ...
                    <select name="industry" id="industry" class="form-control">
                        ...
                        <option value="Capital Markets/Hedge Fund/Private Equity">Capital Markets/Hedge Fund/Private
                            Equity</option>
                        ...
                        <option value="Investment Management/Hedge Fund/Private Equity">Investment Management/Hedge
                        ...
                        <option value="Mechanical or Industrial Engineering">Mechanical or Industrial Engineering
                        </option>
