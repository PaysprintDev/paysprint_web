    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> View Investor News</li>
            </ol>
        </section>
                        ...
                        <div class="box-body">
                            <div class="box-body">
                                <table class="table table-bordered table-striped" id="example3">
                                    ...
                                    <form action="{{ route('update investor news', $data['post']->id) }}" method="POST"
                                        enctype="multipart/form-data">

                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
                                                <legend>Investors News</legend>
                                            </div>
                                            ...
                                            <div class="">
                                                <button type="submit"
                                                    class="col-md-8 btn btn-primary form-control">Update</button>
                                            </div>
                                    </form>
