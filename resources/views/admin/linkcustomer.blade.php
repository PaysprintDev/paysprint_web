            ...
            <div class="box-body">
              ...
              <table class="table table-bordered table-striped" id="userInvoice">
                ...
                <tbody>
                  ...
                  <form action="{{ route('updateinvoicelink') }}" method="POST">
                    @csrf
                      ...
                      <tr>
                        ...
                        <td class="mainText">{{ $currencySymbol."0" }}</td>
                        <td class="mainInput disp-0"><input class="form-control" type="text" name="remaining_balance" value="{{ "0" }}" required=""></td>
                      </tr>
                      <tr>
                      ...
                      <div>
                        <button type="button" class="btn btn-danger" onclick="invoiceLinkVisit('{{ $getCustomer[0]->id }}', 'delete')">Delete <img src="https://i.ya-webdesign.com/images/loading-gif-png-5.gif" class="spinnerdelete disp-0" style="width: 30px; height: 30px;"></button>

                        <button class="btn btn-primary edit" type="button" onclick="invoiceLinkVisit('{{ $getCustomer[0]->id }}', 'edit')">Edit <img src="https://i.ya-webdesign.com/images/loading-gif-png-5.gif" class="spinneredit disp-0" style="width: 30px; height: 30px;"></button>
                        ...
                        <button class="btn btn-warning" type="button" onclick="markasLinkPaid({{ $getCustomer[0]->id }})">Mark as Paid <img src="https://i.ya-webdesign.com/images/loading-gif-png-5.gif" class="spinneredit disp-0" style="width: 30px; height: 30px;"></button>
