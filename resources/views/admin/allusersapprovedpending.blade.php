                    ...
                    <div class="box-body table table-responsive">
                        ...
                        <table class="table table-bordered table-striped" id="example3">
                            ...
                            <tbody>
                                ...
                                @if ($allusersdata = \App\User::where([['country', '=', Request::get('country')],
                                ['account_check', '=', 1]])->orderBy('lastUpdated', 'DESC')->paginate(100))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void()" style="font-weight: bold;" data-toggle="modal"
                                    ...
                                    <td>
                                        ...
                                        <input type="checkbox" name="selfiecheck" id="selfiecheck{{ $datainfo->id }}"
                                        ...
                                        @if ($datainfo->drivers_license_front != null || $datainfo->drivers_license_back
                                        != null)
                                        <small style="font-weight: bold;">
                                        ...
                                        <small style="font-weight: bold;">
                                            ...
                                            <a href="{{ $datainfo->international_passport_back }}" target="_blank">Back
                                                view</a>
                                            @endif
                                        </small>
                                        ...
                                        <input type="checkbox" name="nodocument" id="nodocument{{ $datainfo->id }}"
                                            onchange="checkMyBox('nodocument', '{{ $datainfo->id }}')" checked>
                                    ...
                                    <td align="center">
                                        ...
                                        {{-- <a href="javascript:void()"
                                            onclick="checkverification('{{ $datainfo->id }}')"><i
                                                class="fas fa-user-check text-success" title="Pass Level 1"></i> <img
                                                class="spinvery{{ $datainfo->id }} disp-0"
                                        ...
                                        @if ($datainfo->approval == 2 && $datainfo->accountLevel > 0 &&
                                        $datainfo->account_check == 2)
                                        <a href="javascript:void()" onclick="downgradetoLevel1('{{ $datainfo->id }}')"
                                            class="text-danger"><i class="fas fa-arrow-down text-info"
                                                style="font-size: 20px;" title="Downgrade to Level 1"></i> <img
                                                class="spindowngrade{{ $datainfo->id }} disp-0"
                                                src="https://i.ya-webdesign.com/images/loading-gif-png-5.gif"
                                                style="width: 20px; height: 20px;"></a>
                                        @elseif ($datainfo->approval == 2 && $datainfo->accountLevel > 0 &&
                                        $datainfo->account_check == 1)
                                        <a href="javascript:void()" onclick="approveaccount('{{ $datainfo->id }}')"
                                            class="text-danger"><i class="fas fa-check-square text-success"
                                        ...
                                        <a href="javascript:void()" onclick="disapproveaccount('{{ $datainfo->id }}')"
                                        ...
                                        @elseif ($datainfo->approval == 0 && $datainfo->accountLevel > 0)
                                        <a href="javascript:void()" onclick="approveaccount('{{ $datainfo->id }}')"
                                            class="text-danger"><i class="ffas fa-check-square text-success"
                                                style="font-size: 20px;" title="Approve Account"></i>
                                            <img class="spin{{ $datainfo->id }} disp-0"
                                                src="https://i.ya-webdesign.com/images/loading-gif-png-5.gif"
                                                style="width: 20px; height: 20px;"></a>
                                        ...
                                        <a href="javascript:void(0)"
                                            onclick="$('#launchButton{{ $datainfo->id }}').click()" class="text-info"><i
                                                class="fas fa-paperclip" style="font-size: 20px;"
                                                title="Attachment"></i> </a>

                                        <a href="javascript:void()" onclick="closeAccount('{{ $datainfo->id }}')"
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="myBankInfo{{ $datainfo->id }}" tabindex="-1" role="dialog"
                                    aria-labelledby="myBankInfoTitle" aria-hidden="true">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small style="font-weight: bold;">
                                            ...
                                            <a href="{{ $data->drivers_license_front }}" target="_blank">Front view</a>
                                            @endif | @if ($data->drivers_license_back != null)
                                            <a href="{{ $data->drivers_license_back }}" target="_blank">Back view</a>
                                            @endif
                                        </small>
                                        <hr>
                                        @endif
                                        ...
                                        <small style="font-weight: bold;">
                                            ...
                                            <a href="{{ $data->international_passport_front }}" target="_blank">Front
                                                view</a>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="{{ route('user more detail', $data->id) }}"><i
                                                class="far fa-eye text-primary" style="font-size: 20px;"
                                                title="More details"></i></strong></a>
                                        <a href="javascript:void()" onclick="checkverification('{{ $data->id }}')"><i
                                                class="fas fa-user-check text-success" title="Check verification"></i>
                                            <img class="spinvery{{ $data->id }} disp-0"
                                                src="https://i.ya-webdesign.com/images/loading-gif-png-5.gif"
                                                style="width: 20px; height: 20px;"></a>
                                        @if ($data->approval == 1)
                                        <a href="javascript:void()" onclick="approveaccount('{{ $data->id }}')"
                                            class="text-danger"><i class="fas fa-power-off text-danger"
                                        ...
                                        <button class="btn btn-danger" id="processPay"
                                            onclick="approveaccount('{{ $data->id }}')">Disapprove Identification <img
                                                class="spin{{ $data->id }} disp-0"
                                                src="https://i.ya-webdesign.com/images/loading-gif-png-5.gif"
                                                style="width: 20px; height: 20px;"></button>
                                        @else
                                        <button class="btn btn-primary" id="processPay"
                                            onclick="approveaccount('{{ $data->id }}')">Approve Identification <img
                                                class="spin{{ $data->id }} disp-0"
                                                src="https://i.ya-webdesign.com/images/loading-gif-png-5.gif"
                                                style="width: 20px; height: 20px;"></button>
                                        @endif --}}
