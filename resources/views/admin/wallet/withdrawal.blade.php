            ...
            {{-- <a href="#" class="small-box-footer">View details <i class="fa fa-arrow-circle-right"></i></a> --}}
                    ...
                    <div class="form-group cardform"> 
                            <form action="#" method="POST" id="formElem">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group"> <label for="password">
                                                        Provide Your Login Password <br> <small class="text-danger">We need to be sure it's you</small>
                                                    </label>
                                ...
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary btn-block withdrawmoneyBtn" onclick="handShake('withdrawmoney')" >Withdraw Money</button>
                                </div>
