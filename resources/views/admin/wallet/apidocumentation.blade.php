...
<?php use \App\Http\Controllers\InvoicePayment; ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content body">
      ...
      <section id="download">
        <h2 class="page-header"><a href="#download">Usage</a></h2>
        <p class="lead">
          This API documentation is available in two different method.
        </p>
        <div class="row">
          <div class="col-sm-6">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">CURL</h3>
                <span class="label label-primary pull-right"><i class="fas fa-code"></i></span>
              </div><!-- /.box-header -->
              <div class="box-body">
                <p>cURL is a PHP library and a command line tool (like wget) that helps you send files and also download data over HTTP and FTP.</p>
                <a href="https://www.php.net/manual/en/book.curl.php" target="_blank" class="btn btn-primary"><i class="fas fa-book-reader"></i> Read manual</a>
              </div><!-- /.box-body -->
            </div><!-- /.box -->
          </div><!-- /.col -->
          <div class="col-sm-6">
            <div class="box box-danger">
              <div class="box-header with-border">
                ...
                <span class="label label-danger pull-right"><i class="fab fa-php"></i></i></span>
              </div><!-- /.box-header -->
              <div class="box-body">
                <p>PHP (recursive acronym for PHP: Hypertext Preprocessor ) is a widely-used open source general-purpose scripting language that is especially suited for web development.</b></p>
                <a href="https://www.php.net/manual/en/intro-whatis.php" target="_blank" class="btn btn-danger"><i class="fas fa-book-reader"></i> Read Manual</a>
              </div><!-- /.box-body -->
            </div><!-- /.box -->
          </div><!-- /.col -->
        </div><!-- /.row -->
