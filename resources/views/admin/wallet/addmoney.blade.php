                        ...
                        <form role="form" action="#" method="POST" id="formElem">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="name" class="form-control" id="nameInput"
                                    value="{{ session('firstname') . ' ' . session('lastname') }}" readonly>
                                <input type="hidden" name="email" class="form-control" id="emailInput"
                                    value="{{ session('email') }}" readonly>

                                <input type="hidden" name="paymentToken" class="form-control" id="paymentToken" value=""
                                    readonly>
                            ...
                            <div class="col-md-12 withCardGoogle disp-0">
                                <center>
                                    ...
                                    <div id="moneris-google-pay" store-id="monca04155"
                                        web-merchant-key="8721CF195A6D59C63304681BB18FA9163808950E2743426DBF11CB7D91A74E03">
                                    </div>
                                </center>
                            </div>
                ...
                metadata: {
                    custom_fields: [{
                        ...
                        },
                        {
                            ...
                            value: "Added {{ $data['getuserDetail']->currencySymbol }}" + netamount +
