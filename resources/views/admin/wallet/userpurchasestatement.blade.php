...
<?php use \App\Http\Controllers\InvoicePayment; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Wallet Purchase Report
      </h1>
      <ol class="breadcrumb">
      <li><a href="{{ route('Admin') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">Wallet Purchase Report</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <form action="{{ route('user purchase statement') }}" method="GET">
                @csrf
                  <br>
                <div class="row">
                  <div class="col-md-12">
                    <select data-show-subtext="true" data-live-search="true" name="country" class="form-control selectpicker" id="country">
            ...
            <div class="box-body">
                ...
                <div class="table table-responsive">
                    <table class="table table-striped table-inverse" id="example3">
                        <caption>
                            ...
                            <tbody>
                                @if (count($data['result']) > 0)
                                    @php
                                        $i = 1;
                                    @endphp
                                    @foreach ($data['result'] as $walletstatements)
                                        <tr>
                                            <td scope="row">
                                              <small>
                                                {{ date('d/m/Y', strtotime($walletstatements->created_at)) }}
                                                <br>
                                                {{ date('h:i a', strtotime($walletstatements->created_at)) }}
                                              </small>
                                            </td>
                                            <td>{{ $walletstatements->reference_code }}</td>
                                            <td>{!! $walletstatements->activity !!}</td>
