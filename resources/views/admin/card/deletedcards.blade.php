  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Users Deleted Cards</li>
      </ol>
    </section>
        ...
        <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    @if (count($data['allDeletedCards']) > 0)

                    
                    @php
                        $i = 1;
                    @endphp
                        @foreach ($data['allDeletedCards'] as $data)
                                ...
                                <td>
                                    <a href="{{ route('get user deleted card', $data->user_id) }}" type="button" class="btn btn-primary">View Cards</a>
