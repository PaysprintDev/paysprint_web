  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        @if (count($data['getmydebitCard']) > 0)
        ...
        @foreach ($data['getmydebitCard'] as $mycard)
          ...
          <div class="small-box {{ $alertInfo }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ route('Edit merchant debit card', $mycard->id) }}" title="Edit Card"><i class="far fa-edit text-secondary"></i></a>
            ...
            <div class="alert bg-info">
                        <center>
                            ...
                            <div class="col-md-12">
                                ...
                                <p>
                                    You are yet to add any debit card, start adding your card by clicking the add new card below.
                                </p>
                            ...
                            <form action="#" method="POST" id="formElem">
                                ...
                                <div class="form-group disp-0">
                                    ...
                                    <select name="card_provider" id="card_provider" class="form-control" required>
                                        <option value="Debit Card" selected>Debit VISA/Mastercard</option>
