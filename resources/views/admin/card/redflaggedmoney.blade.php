                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($data->flag_state == 1)
                                                            <td>
                                                                ...
                                                                <form action="{{ route('flag this money') }}"
                                                                    method="post" id="flag{{ $data->transaction_id }}">
                                                                    @csrf <input type="hidden" name="transaction_id"
                                                                        value="{{ $data->transaction_id }}"></form>

                                                                <a type="button" class="btn btn-warning"
                                                                    href="javascript:void(0)"
                                                                    onclick="flagMoney('flag', '{{ $data->transaction_id }}')">Remove
                                                                    Flag</a>
