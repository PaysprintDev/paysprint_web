  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        @if (count($data['getmyprepaidCard']) > 0)
        ...
        @foreach ($data['getmyprepaidCard'] as $mycard)
        ...
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box {{ $alertInfo }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="{{ route('Edit merchant prepaid card', $mycard->id) }}" title="Edit Card"><i class="far fa-edit text-secondary"></i></a>
        ...
        <div class="col-md-12">
            <div class="alert bg-info">
                        <center>
                            ...
                            <div class="col-md-12">
                                <h4>
                                    No Prepaid Card Found!!
                                </h4>
                                <p>
                                    You are yet to add any prepaid card, start adding your card by clicking the add new card below.
                                </p>
