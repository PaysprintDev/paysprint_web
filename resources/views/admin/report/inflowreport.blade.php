  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <li><a href="{{ route('Admin') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">Inflow Report</li>
      </ol>
    </section>
                ...
                <tbody>
                    ...
                    <?php $i = 1; $totalPaid = 0; $remtoPay = 0; $totalinv = 0;?>
                        ...
                        <tr>
                            ...
                            @if($amount = \App\Statement::where('country', $data->country)->sum('credit'))
                            ...
                            <td>
                                <a href="{{ route('inflow by country', 'country='.$data->country) }}" type="button" class="btn btn-primary">View details</a>
                            </td>
                        </tr>
