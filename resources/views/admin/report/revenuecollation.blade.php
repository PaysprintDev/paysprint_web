            ...
            <div class="box-body table table-responsive">
              ...
              <table class="table table-bordered table-striped" id="example3">
                ...
                <?php $expected = 0; $actual= 0;?>
                    ...
                    {{-- Added Money --}}
                    @if($addedAmount = \App\Statement::where('user_id', 'adenugaadebambo41@gmail.com')->where('country', Request::get('country'))->whereBetween('trans_date', [Request::get('start'), Request::get('end')])->where('activity', 'LIKE', '%Added%')->sum('credit'))
                        @php
