                ...
                <tbody>
                    ...
                    @if (count($data['result']) > 0)
                        ...
                        @endif
                                ...
                                <td style="color: red; font-weight: bold; ">{{ "-".$item->currency.' '.number_format($item->amount, 2) }}</td>
                    ...
                    <tr>
                        ...
                        <td style="font-weight: bold; color: black; font-size: 20px;">{{ '-'.$item->currency.' '.number_format($chargetotal, 2) }}</td>
                        <td></td>
