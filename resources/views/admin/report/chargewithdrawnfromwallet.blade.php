            ...
            <div class="box-body table table-responsive">
              ...
              <table class="table table-bordered table-striped" id="example3">
                ...
                <tbody>
                    ...
                    @if (count($data['result']) > 0)
                        ...
                        @foreach ($data['result'] as $item)
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td>{{ $item->name }}</td>
                                <td style="color: red; font-weight: bold; ">{{ "-".$item->currencyCode.' '.number_format($item->debit, 2) }}</td>
                                <td style="color: navy; font-weight: bold; ">{{ "+".$item->currencyCode.' '.number_format($item->chargefee, 2) }}</td>
                                <td>{{ date('d-m-Y', strtotime($item->trans_date)) }}</td>
                            </tr>

                            @php
                            $total += $item->debit;
                            $chargetotal += $item->chargefee;
                        @endphp
                    ...
                    @else
                        <tr>
                            <td colspan="5" align="center">No record for this period</td>
                        </tr>
                    @endif
                    ...
                    <tr>
                        ...
                        <td style="font-weight: bold; color: black; font-size: 20px;">{{ '-'.$item->currencyCode.' '.number_format($total, 2) }}</td>
                        <td style="font-weight: bold; color: green; font-size: 20px;">{{ '+'.$item->currencyCode.' '.number_format($chargetotal, 2) }}</td>
                        <td></td>
