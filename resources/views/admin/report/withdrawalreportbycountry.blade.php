...
<?php use \App\Http\Controllers\ClientInfo; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Withdrawals In {{ Request::get('country') }}
      </h1>
      <ol class="breadcrumb">
      <li><a href="{{ route('Admin') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">Withdrawals In {{ Request::get('country') }}</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <form action="{{ route('get withdrawal record') }}" method="POST">
                  @csrf
                  <div class="row">
                <div class="col-md-6">
              ...
              <table class="table table-bordered table-striped" id="example3">
                ...
                <tbody>
                    ...
                    <?php $i = 1; $totalPaid = 0; ?>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: 700;">{{ $data->currencyCode.' '.number_format($data->debit, 2) }}</td>
                        </tr>

                        @php
                                $totalPaid += $data->debit;
                            @endphp
                ...
                @isset($totalPaid)
                    ...
                    <tr>
                        ...
                        <td style="font-weight: bold; color: red;">{{ '-'.$data->currencyCode.' '.number_format($totalPaid, 2) }}</td>
