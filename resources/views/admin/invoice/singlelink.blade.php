...
@section('dashContent')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Create and Send Invoice To Non-PaySprint Customers
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ route('Admin') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Create and Send Invoice To Non-PaySprint Customers</li>
      </ol>
    </section>
        ...
        <div class="box-body">
            ...
            <form action="#" method="POST" id="formElem">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group has-success">
                            <label for="single_email">Customer Address</label>
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" name="single_address" id="single_address" class="form-control" placeholder="Street No, Street Name, City -  State">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group has-success">
                            <label for="single_email">Customer Country</label>
                            <div class="row">
                                <div class="col-md-12">
                                    <select class="form-control" name="single_country" id="inputSuccess">
            ...
            <!-- /.row -->
                ...
                <div class="box-footer">
                  <button type="button" class="btn btn-primary btn-block" onclick="handShake('singleinvoicelink')" id="cardSubmit">Submit and Generate Link</button>
                </div>
              </form>
