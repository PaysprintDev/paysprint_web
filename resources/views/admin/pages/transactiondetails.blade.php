        ...
        <div class="box">
          ...
          <div class="box-body">
            <div class="col-md-2 col-md-offset-10">
              <button class="btn btn-secondary btn-block bg-blue" onclick="goBack()"><i class="fas fa-chevron-left"></i>
                Go back</button>
            </div>
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="mainText" colspan="2" style="font-weight: bold;">{{ $data['transaction']->transaction_id }}
                  </td>
                </tr>
                <tr>
                  <td>MESSAGE</td>
                ...
                <tr>
                  <td>DATA AMOUNT</td>
                  <td class="mainText" colspan="2" style="font-weight: bold;">{{
                    $newData['data']['currency'].''.number_format($newData['data']['amount'] , 2) }}</td>
                </tr>
                <tr>
                  <td>PAYMENT TYPE</td>
                ...
                <tr>
                  <td>IS SUCCESSFUL</td>
                  <td class="mainText" colspan="2" style="font-weight: bold;">{{ $newData['data']['isSuccessful'] ===
                    true ? 'TRUE' : 'FALSE' }}</td>
                </tr>
                <tr>
                  <td>GATEWAY RESPONSE</td>
                  <td class="mainText" colspan="2" style="font-weight: bold;">{{ $newData['data']['gatewayResponse'] }}
                  </td>
                </tr>
                ...
                @else
                <tr>
                  <td colspan="2" style="color: red; font-weight: bold;" align="center">No gateway response retrieved
