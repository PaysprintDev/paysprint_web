                        ...
                        <table class="table table-bordered table-striped" id="example3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $userStatement->name }} {!! $data->flag_state == 1 ? '<img
                                            src="https://img.icons8.com/emoji/20/000000/triangular-flag.png" />' : ''
                                        !!}
                                    </td>
                                    @else
                                    <td>- {!! $data->flag_state == 1 ? '<img
                                            src="https://img.icons8.com/emoji/20/000000/triangular-flag.png" />' : ''
                                        !!}</td>
                                    @endif
                                    @else
                                    ...
                                    <td>{{ $data->activity }}</td>
                                    <td><a href="{{ route('check transaction', $data->transaction_id) }}">View
                                            details</a></td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('flag this money') }}" method="post"
                                            id="flag{{ $data->transaction_id }}">@csrf <input type="hidden"
                                                name="transaction_id" value="{{ $data->transaction_id }}"></form>
                                    ...
                                    <td>
                                        ...
                                        <a type="button" class="btn btn-danger" href="javascript:void(0)"
                                            style="cursor: not-allowed" disabled>Reverse
                                            <img src="https://img.icons8.com/office/20/000000/spinner-frame-4.png"
                                                class="fa fa-spin spin{{ $data->transaction_id }} disp-0"></a>
