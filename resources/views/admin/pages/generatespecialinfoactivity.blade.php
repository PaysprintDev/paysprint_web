    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Create Special Information</li>
            </ol>
        </section>
                ...
                <div class="box-body">
                    ...
                    <form role="form" action="{{ route('create special information') }}" method="POST">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group has-success">
                                <label class="control-label" for="inputSuccess"> Communication Means</label>
                                <select name="communication" id="communication" class="form-control" required>
                                    <option value="">Select Communication Means</option>
