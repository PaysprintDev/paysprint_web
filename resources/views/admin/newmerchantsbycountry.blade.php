                    ...
                    <?php $i = 1;?>
                        ...
                        <tr>
                            ...
                            @if (Request::get('user') == "new")
                                ...
                                @if($allusersdata = \App\User::where('accountType', 'Merchant')->where('archive', 0)->where('countryapproval', 1)->where('country', $data->country)->where('created_at', '>=', date('Y-m-d', strtotime('-30 days')))->count())
                                    <td>{{ $allusersdata }}</td>
                                @endif
