    ...
    <section class="content-header">
      <h1>
        @if (Request::get('country') != null)
         All Pending KYB In {{ Request::get('country') }}
            ...
            <div class="box-body table table-responsive">
              ...
              <table class="table table-bordered table-striped" id="example3">
                ...
                <tbody>
                  ...
                  @if($allusersdata = \App\User::where('country', Request::get('country'))->where('accountType', 'Merchant')->where('accountLevel', '<=', 2)->where('approval', '<=', 1)->get())
