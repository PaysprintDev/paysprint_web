        ...
        <section class="content-header">
            <h1>
                @if (Request::get('country') != null)
                    All Completed KYB In {{ Request::get('country') }}
                @else
                    All Completed KYB
                @endif
            </h1>
                        ...
                        <div class="box-body table table-responsive">
                            ...
                            <table class="table table-bordered table-striped" id="example3">
                                ...
                                <tbody>
                                    ...
                                    @if ($allusersdata = \App\User::where('country', Request::get('country'))->where('accountType', 'Merchant')->where('accountLevel', 3)->where('approval', 2)->get())
