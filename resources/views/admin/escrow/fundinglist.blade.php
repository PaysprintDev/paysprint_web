                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a target="_blank" href="{{ route('user more detail', $user->id) }}" type="button" class="btn btn-success">View profile</a>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('delete es pay', 'escrow_id=' . $escrowNumber) }}" method="post" id="delthisform{{ $escrowNumber }}" style="visibility: hidden;">@csrf</form>

                                        <a href="#" type="button" class="btn btn-danger" onclick="declineEsPay('{{ $escrowNumber }}')">Decline
                                            payment</a>
                                    </td>
                                    @endif
