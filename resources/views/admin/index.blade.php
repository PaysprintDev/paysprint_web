        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xs-6 walletBal">
                ...
                <div class="small-box bg-warning">
                    <div class="inner">
                        <h3>{{ $getUserDetail->currencySymbol . number_format($getUserDetail->wallet_balance, 2) }}
                        </h3>
            ...
            <div class="col-lg-4 col-xs-6 walletWithdrawal">
                ...
                <div class="small-box bg-info">
                    ...
                    {{-- <a href="{{ route('Otherpay') }}" class="small-box-footer">More info <i
            ...
            <div class="col-lg-6 col-xs-6 myCardInfo">
                ...
                <div class="small-box bg-success">
                    <div class="inner">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3 style="font-size: 30px;">
                                    {{ strlen($cardNo) < 10 ? $cardNo : substr($cardNo, 0, 10) . '***' }} {{ $others> 0
                                        ? '& ' . $others . ' others' : '' }}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4>
                                    {{ strlen($getCard[0]->card_name) < 18 ? strtoupper($getCard[0]->card_name) :
                                        substr(strtoupper($getCard[0]->card_name), 0, 18) . '...' }}
                                </h4>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <p>
                            <a href="{{ route('merchant payment gateway', 'gateway=PaySprint') }}">Add a new
                                card</a>
                        </p>
                        @endif
                ...
                {{-- <div class="small-box bg-primary">
                    ...
                    <a href="{{ route('merchant profile') }}" class="small-box-footer">Continue <i
                            class="fa fa-arrow-circle-right"></i></a>
                </div> --}}
                ...
                <div class="col-md-12">
                    ...
                    <button style="background-color: #000 !important;" class="px-2" title="PaySprint Payment Gateway"
                        onclick="location.href='{{ route('merchant payment gateway', 'gateway=PaySprint') }}'">
                    ...
                    <button class="px-2" title="GooglePay Payment Gateway" onclick="comingSoon()"><img
                ...
                <div class="col-md-4 mb-3 sendMoney">
                    <a style="font-size: 14px; font-weight: bold;" type="button"
                        href="{{ route('merchant send money', 'type=' . base64_encode('local')) }}"
                        class="btn btn-warning btn-block">Send Money (Local) <i class="fas fa-paper-plane"></i></a>
                </div>

                @if ($imt = \App\AllCountries::where('name', session('country'))->where('imt',
                'true')->orWhere('outbound', 'true')->first())
                <div class="col-md-4 mb-3 sendMoney">
                    <a style="font-size: 14px; font-weight: bold; color: white; background: purple" type="button"
                        href="{{ route('merchant send money', 'type=' . base64_encode('international')) }}"
                        class="btn btn-default btn-block">Send Money (Abroad) <i class="fas fa-paper-plane"></i></a>
                ...
                <div class="col-md-4 mt-5 mb-3 payinvoiceMoney">
                    <a style="font-size: 14px; font-weight: bold;" type="button" href="{{ route('invoice') }}"
                        class="btn btn-danger btn-block mt-5 mb-3">Pay Invoice <i class="fas fa-credit-card"></i></a>
                </div>

                <div class="col-md-4 mt-5 mb-3 payutilityMoney">

                    @if (session('country') == 'Nigeria')
                    <a style="font-size: 14px; font-weight: bold; background: black; color: white;" type="button"
                        href="{{ route('utility bills') }}" class="btn btn-info btn-block mt-5 mb-3">Pay Utility Bill <i
                            class="fas fa-credit-card"></i></a>
                    @else
                    <a style="font-size: 14px; font-weight: bold; background: black; color: white;" type="button"
                        href="{{ route('select utility bills country', 'country=' . session('country')) }}"
                        class="btn btn-info btn-block mt-5 mb-3">Pay Utility Bill <i class="fas fa-credit-card"></i></a>
                    @endif
                ...
                <div class="box box-primary receivedMoney">
                    ...
                    <div class="box-body table table-responsive">
                        <table id="example3" class="table table-bordered table-hover">
                            {{-- @if (session('role') != 'Super')<caption><button type="button" class="btn btn-success"
                                    style="float:right" id="recurAll"
                                    onclick="recurring('All', {{ session('user_id') }})">Recur All</button></caption>
                            @endif --}}
                            <thead>
                                <tr>
                                    <th>#</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $payInv->invoice_no }} {!! $countryBase != session('country') ? '<img
                        ...
                        <table id="example4" class="table table-bordered table-hover">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    && session('role') != 'Access to Level 1 only')
                                    <th>Action</th>
                                    @endif
                                </tr>
                            </thead>
...
echo $output; ?>
                                    ...
                                    <td align="center" style="font-weight: bold; color: navy;">
                                        ...
                                        @else
                                        {{ number_format($invoiceImports->amount, 2) }}
                                        @endif
                                    </td>
                                    ...
                                    <td align="center" style="font-weight: bold; color: purple;">
                                        ...
                                        @else
                                        {{ number_format($invoiceImports->tax_amount, 2) }}
                                        @endif
                                    </td>
                                    ...
                                    <td align="center" style="font-weight: bold; color: green;">
                                        ...
                                        @else
                                        {{ number_format($invoiceImports->total_amount, 2) }}
                                        @endif
                                    </td>
                                    ...
                                    {{-- @if ($leftOver = \App\InvoicePayment::where('invoice_no',
                                    $invoiceImports->invoice_no)->get())
...
echo $output; ?>
                                    ...
                                    <td align="center" style="font-weight: bold; color: navy;">
                                        @if (isset($getUserDetail) == true)
                                        {{ $getUserDetail->currencySymbol . number_format($invoiceLinkImports->amount,
                                        2) }}
                                        @else
                                        {{ number_format($invoiceLinkImports->amount, 2) }}
                                        @endif
                                    </td>

                                    <td align="center" style="font-weight: bold; color: purple;">
                                        @if (isset($getUserDetail) == true)
                                        {{ $getUserDetail->currencySymbol .
                                    ...
                                    {{-- @if ($leftOver = \App\InvoicePayment::where('invoice_no',
                                    $invoiceLinkImports->invoice_no)->get())
