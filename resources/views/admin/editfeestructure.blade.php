    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
            ...
            @if (isset($getTransfee))

            {{-- Provide Form --}}
            <form role="form" action="{{ route('edit fee structure', $getTransfee->id) }}" method="POST">
                @csrf
                <div class="box-body">
                    <div class="form-group has-success">
                        ...
                        <select name="country" id="country" class="form-control" required>
                            ...
                            <option value="{{ $getTransfee->country }}" selected>{{ $getTransfee->country }}</option>
                    ...
                    <div class="form-group has-success">
                        ...
                        <select name="structure" id="structure" class="form-control">
                            ...
                            <option value="{{ $getTransfee->structure }}" selected>{{ $getTransfee->structure }}</option>
                        </select>
                        {{-- <input type="text" class="form-control" name="name" id="inputSuccess" placeholder="E.g Belt Work"> --}}
                    </div>
                    <div class="form-group has-success">
                        ...
                        <select name="method" id="method" class="form-control">
                            ...
                            <option value="{{ $getTransfee->method }}" selected>{{ $getTransfee->method }}</option>
                        </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group has-success">
                                ...
                                <input type="number" min="0.00" step="0.01" class="form-control" name="fixed" id="fixed" placeholder="1.35" value="{{ $getTransfee->fixed }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group has-success">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                          <div class="form-group has-success">
                              ...
                              <input type="number" min="0.00" step="0.01" class="form-control" name="fixed" id="fixed" placeholder="1.35" value="{{ $getTransfee->basic }}">
                          </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group has-success">
                              <label class="control-label" for="inputSuccess"> Classic</label>
                              <input type="number" min="0.00" step="0.01" class="form-control" name="variable" id="variable" placeholder="0.98%" value="{{ $getTransfee->classic }}">
                          </div>
                      </div>
                  </div>
                ...
                <div class="box-footer">
                  <button type="submit" class="btn btn-primary btn-block">Update and Save</button>
                </div>
              </form>
