            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        {!! session('msg') !!}
                        <h3 class="box-title"> Suspended Stores</h3>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="{{ $value->status == 'not active' ? 'text-danger' : 'text-success' }} text-center">
                                            {{ $value->status }}
                                        </p>
                                    ...
                                    <td>
                                        <a href="{{ route('send message', 'id=' . $user->id . '&route=') }}" class="btn btn-success">Message Merchant</a>
                                    </td>
                                    <td>
                                        <!-- <a href="{{ route('edit store', $value->id) }}" class="btn btn-primary">Edit Store</a> -->
                                    </td>
                                    <td>
                                        <button class="btn btn-success" id="btns{{ $value->id }}" onclick="deleteStore('{{ $value->id }}');">Restore
                                            Store</button>
                                        <form action="{{ route('restore store', $value->id) }}" method="post" style="visibility: hidden" id="deletestore{{ $value->id }}">
                                            @csrf
