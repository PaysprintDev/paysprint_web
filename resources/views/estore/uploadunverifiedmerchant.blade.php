...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Upload Unverified Merchants Lists
		</h1>
		<ol class="breadcrumb">
			<li><a href="{{ route('Admin') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
			<li class="active">Upload Unverified Merchants Lists</li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="container-fluid">
						<div class="row">
							<form action="{{route('upload unverified merchants')}}" method="post" enctype="multipart/form-data">
								@csrf
								<div class="col-md-12 mb-2">
									<label>Import List</label>
									<input type="file" name="unverified_docs" class="form-control">
								</div>
