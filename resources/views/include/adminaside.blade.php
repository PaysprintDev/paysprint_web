        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                ...
                $usersName = strlen(session('firstname') . ' ' . session('lastname')) < 15 ? session('firstname') . ' '
                    ...
                    'Access to Level 1 and 2 only' && session('role') != 'Customer Marketing' || session('role') !=
                    'Customer Success')
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li title="Moneris"><a href="{{ route('gateway activity', 'gateway=moneris') }}"><i
                                        class="fa fa-circle-o text-red"></i> Moneris</a></li>
                            <li title="PayStack"><a href="{{ route('gateway activity', 'gateway=paystack') }}"><i
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li title="Payment Gateway"><a href="{{ route('create payment gateway') }}"><i
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li title="Mobile Money"><a href="{{ route('mobilemoney request withdrawal') }}"><i
                                class="fa fa-circle-o text-red"></i> Mobile Money</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li title="Wallet Purchase Refund"><a href="{{ route('purchase refund request') }}"><i
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li title="Currency Conversion Mark Up"><a href="{{ route('markup conversion') }}"><i
            ...
            'Access to Level 1 and 2 only' && session('role') != 'Customer Marketing' || session('role') != 'Customer
            Success')
            ...
            <li class="quicksetup">
                        ...
                        <li class="list-group-item" title="Rental Property Management">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="javascript:void()" onclick="whatyouOffer('{{ session('email') }}')"
                ...
                <div class="card" style="width: auto;">
                    <div class="card-header"
                        ...
                        Quick Wallet Setup
                        @if ($getUserDetail->approval == 0 || (count($getCard) <= 0 && count($getBank) <=0) ||
                            $getUserDetail->transaction_pin == null || $getUserDetail->securityQuestion == null)
                            <br>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! count($getCard) > 0 || count($getBank) > 0 ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                        ...
                        <li class="list-group-item" title="Setup transaction pin for security purpose">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! $getUserDetail->transaction_pin != null ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                        ...
                        <li class="list-group-item" title="Setup transaction pin for security purpose">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! $getUserDetail->securityQuestion != null ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                        ...
                        <li class="list-group-item" title="Bank Verification (BVN)">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    0 ? "<img src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                            </div>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item" title="Articles of Incorporation">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! $data['getuserDetail']->incorporation_doc_front != null ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                        ...
                        <li class="list-group-item" title="Register of Directors">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! $data['getuserDetail']->directors_document != null ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                        ...
                        <li class="list-group-item" title="Register of Shareholders">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! $data['getuserDetail']->shareholders_document != null ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                        ...
                        <li class="list-group-item" title="Proof of Identity - 1 Director">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! $data['getuserDetail']->proof_of_identity_1 != null ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                        ...
                        <li class="list-group-item" title="Proof of Identity - 1 UBO">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! $data['getuserDetail']->proof_of_identity_2 != null ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                        ...
                        <li class="list-group-item" title="AML Policy and Procedures">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! $data['getuserDetail']->aml_policy != null ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                        ...
                        <li class="list-group-item" title="Latest Compliance External Audit Report">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! $data['getuserDetail']->compliance_audit_report != null ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                        ...
                        <li class="list-group-item"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! $data['getuserDetail']->organizational_chart != null ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
                        ...
                        <li class="list-group-item" title="Proof of Financial License">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {!! $data['getuserDetail']->financial_license != null ? "<img
                                        src='https://img.icons8.com/fluent/20/000000/check-all.png' />" : "<img
                                        class='fa-blink' src='https://img.icons8.com/fluent/20/000000/cancel.png' />"
                                    !!}
                                </div>
