                     ...
                     <li class="treeview disp-0">
                         ...
                         <ul class="treeview-menu">
                             <li><a href="{{ route('paycaremittance') }}"><i class="fa fa-circle-o text-green"></i>
                                     Invoice </a></li>
                             <li><a href="{{ route('remittance') }}"><i class="fa fa-circle-o text-red"></i> Money
                                     Transfer</a></li>
                             {{-- <li><a href="#"><i class="fa fa-circle-o text-warning"></i> Check Event Status</a></li> --}}
                         </ul>
                     </li>
          ...
          <a href="{{ route('xpaytrans') }}">
            ...
            <li><a href="#"><i class="fa fa-circle-o text-warning"></i> Check Event Status</a></li> --}}
                 ...
                 <li class="treeview performanceReport">
                     ...
                     <ul class="treeview-menu">
                         ...
                         <li><a href="{{ route('paid invoice') }}"><i class="fa fa-circle-o text-info"></i> Paid
                                 Invoice</a></li>
                         <li><a href="{{ route('unpaid invoice') }}"><i class="fa fa-circle-o text-info"></i> Unpaid
                         ...
                         <li><a href="{{ route('tax report') }}"><i class="fa fa-circle-o text-info"></i> Taxes
                                 Report</a></li>
                         <li><a href="{{ route('invoice type') }}"><i class="fa fa-circle-o text-info"></i> Invoice
                                 Type Report</a></li>
                                 ...
                                 @if ($getUserDetail->country == 'Nigeria')
                                     <li class="list-group-item" title="Bank Verification (BVN)">
                                         ...
                                         <div class="row">
                                             <div class="col-md-10">
                                                 <a href="{{ route('merchant profile') }}"
                                                     style="color: navy; font-weight: 700;">Bank Verification (BVN) </a>
                                             </div>
                                             <div class="col-md-2">
                             ...
                             <ul class="list-group list-group-flush">
                                 <li class="list-group-item" title="Articles of Incorporation">
                                     <div class="row">
                                         <div class="col-md-10">
                                             <a href="{{ route('merchant profile') }}"
                                                 style="color: black; font-weight: bold;">Articles of Incorporation</a>
                                         </div>
                                         <div class="col-md-2">
                                 ...
                                 <li class="list-group-item" title="Register of Shareholders">
                                     ...
                                     <div class="row">
                                         <div class="col-md-10">
                                             <a href="{{ route('merchant profile') }}"
                                                 style="color: black; font-weight: bold;">Register of Shareholders</a>
                                         </div>
                                         <div class="col-md-2">
                                 ...
                                 <li class="list-group-item" title="Proof of Identity - 1 UBO">
                                     ...
                                     <div class="row">
                                         <div class="col-md-10">
                                             <a href="{{ route('merchant profile') }}"
                                                 style="color: black; font-weight: bold;">Proof of Identity - 1 UBO</a>
                                         </div>
                                         <div class="col-md-2">
                                 ...
                                 <li class="list-group-item" title="AML Policy and Procedures">
                                     ...
                                     <div class="row">
                                         <div class="col-md-10">
                                             <a href="{{ route('merchant profile') }}"
                                                 style="color: black; font-weight: bold;">AML Policy and Procedures</a>
                                         </div>
                                         <div class="col-md-2">
                                 ...
                                 <li class="list-group-item" title="Latest Compliance External Audit Report">
                                     ...
                                     <div class="row">
                                         <div class="col-md-10">
                                             <a href="{{ route('merchant profile') }}"
                                                 style="color: black; font-weight: bold;">Latest Compliance Exter...</a>
                                         </div>
                                         <div class="col-md-2">
                                 ...
                                 <li class="list-group-item" title="Proof of Financial License">
                                     ...
                                     <div class="row">
                                         <div class="col-md-10">
                                             <a href="{{ route('merchant profile') }}"
                                                 style="color: black; font-weight: bold;">Proof of Financial License</a>
                                         </div>
                                         <div class="col-md-2">
                 ...
                 <li class="treeview disp-0">
                     ...
                     <ul class="treeview-menu">
                         <li><a href="{{ route('payreport') }}"><i class="fa fa-circle-o text-info"></i> PaySprint
                                 Collection Report</a></li>
                         <li><a href="{{ route('epayreport') }}"><i class="fa fa-circle-o text-info"></i> Send Money
                                 Collection Report</a></li>
