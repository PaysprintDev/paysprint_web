            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    {{-- <li title="Processed Payment"><a href="{{ route('processed payment') }}"><i
                                class="fa fa-circle-o text-red"></i> Processed Payment</a></li> --}}
                     ...
                     @if (session('role') == 'Super' || session('role') == 'Access to Level 1 and 2 only' || session('role') == 'Access to Level 1 only')
                         ...
                         @if (session('role') == 'Super' || session('role') == 'Access to Level 1 and 2 only' || session('role') == 'Access to Level 1 only')
                             ...
                             <ul class="treeview-menu">
                                 ...
                                 <li title="Setup Payment Gateway"><a href="{{ route('create payment gateway') }}"><i class="fa fa-circle-o text-red"></i>
