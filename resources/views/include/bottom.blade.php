    ...
    <div class="container">
        <div class="footer_row row">
            <div class="col-md-3 col-sm-6 footer_about">
                ...
                <img src="https://res.cloudinary.com/pilstech/image/upload/v1603726392/pay_sprint_white_horizotal_mb5ouw.png"
                ...
                <ul class="socail_icon">
                    ...
                    <li><a href="https://twitter.com/EXBC2" target="_blank"><i class="fa fa-twitter"
            ...
            <div class="col-md-3 col-sm-6 footer_about quick">
                ...
                <ul class="quick_link">
                    ...
                    @auth
                        <li onclick="$('#sendMoney').click()"><a href="javascript:void()"><i
                                    class="fa fa-chevron-right"></i>Money Transfer</a></li>
            ...
            <div class="col-md-3 col-sm-6 footer_about">
                ...
                <ul class="quick_link">
                    ...
                    <li><a href="{{ route('community') }}"><i class="fa fa-chevron-right"></i>Community Forum</a></li>
                    <li><a href="{{ route('terms of use') }}"><i class="fa fa-chevron-right"></i>Terms of Use</a></li>
                    <li><a href="{{ route('privacy policy') }}"><i class="fa fa-chevron-right"></i>Privacy Policy</a>
                    </li>
                    ...
                    @guest
                        ...
                        <li><a href="{{ route('register') }}"><i class="fa fa-chevron-right"></i>Sign Up for FREE</a>
                        </li>
                    @endguest
