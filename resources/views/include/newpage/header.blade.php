                       ...
                       <ul class="navbar-nav main-menu">
                           ...
                           @if (Session::has('username') == false)
                               @guest
                                   ...
                                   <li class="nav-item">
                                       <a class="nav-link" @guest href="{{ route('merchant home') }}" @endguest
                                           @auth href="{{ route('Admin') }}" @endauth role="button"
                           ...
                           @if (Session::has('username') == true)
                               ...
                               <li class="nav-item">
                                   <a class="nav-link" href="{{ route('create single invoice') }}"
                                       role="button" aria-expanded="false">INVOICE</a>
                               </li>
