           ...
           <div class="container-fluid pr-lg-9 pl-lg-9">
               <nav class="navbar site-navbar offcanvas-active navbar-expand-lg  px-0 fixed-top"
                   ...
                   <div class="brand-logo">
                       ...
                       @endauth><img src="{{ asset('images/paysprint_logo/merchant.png') }}"
                                    ...
                                    @if (Session::has('username') == false)
                                        @guest
                                            ...
                                            <li class="nav-item">
                                                ...
                                                href="{{ route('Admin') }}" @endauth role="button"
   ...
   <div class="container-fluid pr-lg-9 pl-lg-9">
       <nav class="navbar site-navbar offcanvas-active navbar-expand-lg px-0 fixed-top"
           ...
           <div class="brand-logo">
               ...
               @endauth><img src="{{ asset('images/paysprint_logo/money-transfer.png') }}"
                   class="light-version-logo " style="width: 200px; height: inherit;"></a>
       ...
       <div class="collapse navbar-collapse" id="mobile-menu">
           <div class="navbar-nav-wrapper">
               ...
               @guest
                   ...
                   {{-- <li class="nav-item">
                       <a class="nav-link" href="{{ route('accounts') }}"
                           style="color: #000000 !important; text-decoration: none; background-color: #e8aa07; border-radius: 10px; font-size: 17px;">{{ 'Get Started' }}</a>
                   </li> --}}
               ...
               @auth
                   <li class="nav-item">
                       <a class="nav-link" href="{{ route('my account') }}" role="button"
                           aria-expanded="false">MY WALLET</a>
                   </li>

                   <li class="nav-item">
                       <a class="nav-link" href="javascript:void()" onclick="$('#sendMoney').click()"
                           role="button" aria-expanded="false">MONEY TRANSFER</a>
                   </li>
                   ...
                   <li class="nav-item dropdown">
                       ...
                       <a class="nav-link dropdown-toggle gr-toggle-arrow" id="navbarDropdown"
                           href="#features" role="button" data-toggle="dropdown" aria-haspopup="true"
                           aria-expanded="false">{{ strlen(Auth::user()->name) < 10 ? Auth::user()->name : substr(Auth::user()->name, 0, 10) . '...' }}
                           <i class="icon icon-small-down"></i></a>
                       <ul class="gr-menu-dropdown dropdown-menu" aria-labelledby="navbarDropdown">
                           <li class="drop-menu-item">
                               <a href="javascript:void()">
