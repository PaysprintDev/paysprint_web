@if ($pages == 'Merchant' || $pages == 'Merchant Pricing')
            ...
            <div class="collapse navbar-collapse" id="mobile-menu">
                <div class="navbar-nav-wrapper">
                    <ul class="navbar-nav main-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" @guest href="{{ route('merchant home') }}" @endguest @auth
                                href="{{ route('Admin') }}" @endauth role="button" aria-expanded="false">HOME</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('create single invoice') }}" role="button"
                                aria-expanded="false">INVOICE</a>
                        </li>


                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('getStatement') }}" role="button"
                                aria-expanded="false">TRANSACTION HISTORY</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('api integration') }}" role="button"
                                aria-expanded="false">API INTEGRATION</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('earned points') }}" role="button"
                                aria-expanded="false">EARNED POINTS</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle gr-toggle-arrow" id="navbarDropdown" href="#features"
                                ...
                                strlen(session('firstname') . ' ' . session('lastname')) < 10 ? session('firstname')
                                    . ' ' . session('lastname') : substr(session('firstname') . ' ' .
                                    session('lastname'), 0, 10) . '...' }} <i class="icon icon-small-down"></i></a>
            ...
            <div class="collapse navbar-collapse" id="mobile-menu">
                <div class="navbar-nav-wrapper">
                    <ul class="navbar-nav main-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('register') }}" role="button" aria-expanded="false">SIGN
                                UP FOR FREE</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('merchant home') }}"
                                style="color: #000000 !important; text-decoration: underline; background-color: #e8aa07; border-radius: 10px; font-size: 17px; padding: 5px;">{{
                                'Business Account? ' . strtoupper(' CLICK HERE') }}</a>
                        </li>
                        {{-- <li class="nav-item">
                            <a class="nav-link" href="{{ route('accounts') }}"
                                style="color: #000000 !important; text-decoration: none; background-color: #e8aa07; border-radius: 10px; font-size: 17px;">{{
                                'Get Started' }}</a>
                        </li> --}}
                        ...
                        <li class="nav-item dropdown dropdown-mega disp-0">
                            <a class="nav-link dropdown-toggle gr-toggle-arrow" id="navbarDropdown90" href="#features"
                            ...
                            <div class="gr-megamenu-dropdown center dropdown-menu d-lg-flex"
                                ...
                                <div class="col-lg-5 pl-0 d-none d-lg-flex align-items-center">
                                    <a href="https://shade.uxtheme.net/shade-pro"
                                        ...
                                        style="background-image: url(image/elements/menu-image.jpg)">
                                    </a>
                                </div>
                                <ul class="col-lg-7 col-xl-6 row-lg list-unstyled py-lg-7">
                                    <li class="col-lg-4">
                                        <div class="single-dropdown-block">
                                            ...
                                            <a href="components/elements-heros.html" class="mega-drop-menu-item">Hero
                                                Area</a>
