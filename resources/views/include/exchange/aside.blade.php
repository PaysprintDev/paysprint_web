...
<nav class="navbar navbar-vertical navbar-expand-lg navbar-light">
    <a class="navbar-brand mx-auto d-none d-lg-block my-0 my-lg-4" href="#">
        <img src="https://res.cloudinary.com/pilstech/image/upload/v1603726392/pay_sprint_black_horizotal_fwqo6q.png"
            alt="Muze">
        <img src="https://res.cloudinary.com/pilstech/image/upload/v1603726392/pay_sprint_black_horizotal_fwqo6q.png"
            alt="Muze" class="white-logo2">
        <img src="https://res.cloudinary.com/pilstech/image/upload/v1617797524/paysprint_asset/paysprint_icon_png_rhxm1e.png"
            class="muze-icon" alt="Muze">
        <img src="https://res.cloudinary.com/pilstech/image/upload/v1617797524/paysprint_asset/paysprint_icon_png_rhxm1e.png"
            class="muze-icon-white" alt="Muze">
    </a>
    <div class="navbar-collapse">
        <ul class="navbar-nav mb-2" id="accordionExample" data-simplebar>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#sidebarSendMoney" data-bs-toggle="collapse" role="button"
                ...
                <div class="collapse collapse-box show" id="sidebarSendMoney" data-bs-parent="#accordionExample">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="#" class="nav-link">Local</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link active">International</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#sidebarMarketPlace" data-bs-toggle="collapse" role="button"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#sidebarEWallet" data-bs-toggle="collapse" role="button"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#sidebarBamkAccount" data-bs-toggle="collapse" role="button"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        <g data-name="Icons/Tabler/Paperclip" transform="translate(0 0)">
                            ...
                            class="status bg-warning ms-2 position-absolute">&nbsp;</sup></span>
                </a>
