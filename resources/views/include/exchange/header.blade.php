        ...
        <div class="header-body px-3 px-xxl-5 py-3 py-lg-4">
            <div class="row align-items-center">
                <a href="javascript:void(0);" class="muze-hamburger d-block d-lg-none col-auto">
                    <img src="https://res.cloudinary.com/pilstech/image/upload/v1633640629/paysprint_asset/hamburger1_qkzb73.svg"
                        alt="img">
                    <img src="https://res.cloudinary.com/pilstech/image/upload/v1633640676/paysprint_asset/close1_kk4ugu.svg"
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light top-header-nav">
                        <div class="navbar-collapse">
                            <ul class="navbar-nav" id="accordionExample2">
                                ...
                                {{-- sidebarSendMoney1 --}}
                                <li class="nav-item">
                                    <a class="nav-link collapsed" href="#sidebarSendMoney1" data-bs-toggle="collapse"
                                        ...
                                        </svg> &nbsp;<span class="ms-2">Send Money</span>
                                    </a>
                                    <div class="collapse collapse-box" id="sidebarSendMoney1"
                                ...
                                {{-- sidebarMarketPlace3 --}}
                                <li class="nav-item">
                                    <a class="nav-link collapsed" href="#sidebarMarketPlace3" data-bs-toggle="collapse"
                                        ...
                                        </svg> &nbsp;<span class="ms-2">Market Place</span>
                                    </a>
                                ...
                                {{-- sidebarEWallet2 --}}
                                <li class="nav-item">
                                    <a class="nav-link collapsed" href="#sidebarEWallet2" data-bs-toggle="collapse"
                                        ...
                                        </svg> &nbsp;<span class="ms-2">E-Wallet</span>
                                    </a>
                                </li>

                                {{-- sidebarBankAccount2 --}}
                                <li class="nav-item">
                                    <a class="nav-link collapsed" href="#sidebarBankAccount2" data-bs-toggle="collapse"
                                        ...
                                        </svg> &nbsp;<span class="ms-2 position-relative">Bank Account <sup
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        ...
                                        </svg> &nbsp;<span class="ms-2">Transaction History</span>
                                    </a>
                                </li>
                ...
                <div class="col-auto d-flex flex-wrap align-items-center icon-blue-hover ps-0">
                    ...
                    <div class="dropdown grid-option">
                        ...
                        <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="chat">
                            <div class="dropdown-header d-flex align-items-center px-4 py-2">
                                <span
                                    class="fs-16 Montserrat-font font-weight-semibold text-black-600">Notification</span>
                                <div class="dropdown ms-auto">
                                    <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"
                                        id="morebtn3" class="btn btn-dark-100 btn-icon btn-sm rounded-circle my-1">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="morebtn3">
                                        ...
                                        <li><a class="dropdown-item" href="#"><svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <g data-name="Icons/Tabler/Share" transform="translate(0)">
                                                        <rect data-name="Icons/Tabler/Code background" width="16"
                                                        ...
                                                        <path
                                                            ...
                                                            transform="translate(0 1)" fill="#495057"></path>
                                                    </g>
                                                </svg><span class="ms-2">HTML</span></a></li>
                                        <li><a class="dropdown-item" href="#"><svg data-name="Icons/Tabler/Share"
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16">
                                                    <rect data-name="Icons/Tabler/File background" width="16"
                                                        height="16" fill="none"></rect>
                                                    <path data-name="Combined Shape"
                                                        ...
                                                        transform="translate(2)" fill="#495057"></path>
                                                </svg><span class="ms-2">XML</span></a></li>
                                        <li><a class="dropdown-item" href="#"><svg data-name="Icons/Tabler/Share"
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16">
                                                    <rect data-name="Icons/Tabler/Code02 background" width="16"
                                                        height="16" fill="none"></rect>
                                                    <path data-name="Combined Shape"
                                        ...
                                        <li><a class="dropdown-item" href="#"><svg data-name="Icons/Tabler/Share"
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16">
                                                    <rect data-name="Icons/Tabler/Share background" width="16"
                                                        height="16" fill="none"></rect>
                                                    <path
                            ...
                            <div class="dropdown-body" data-simplebar>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body ps-1">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="font-weight-semibold tiny text-gray-600 ms-auto">Just
                                                    now</span>
                                            </div>
                                            <span class="d-block small text-gray-600 mt-1 dropdown-content">Hey,
                                                I just found out what’s causing the server to crash!</span>
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="dropdown-item text-wrap unread">
                                    <div class="media">
                                        <span class="d-flex align-items-center">
                                            <span
                                                class="avatar-status avatar-sm-status avatar-primary position-relative me-2 end-0 bottom-0">&nbsp;</span>
                                            <span
                                                class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img
                                                    src="cfx/assets/img/avatar-sm.png" alt="Facebook"><span
                                                    class="avatar-status avatar-sm-status avatar-success">&nbsp;</span></span>
                                        </span>
                                        <div class="media-body ps-1">
                                            <div class="d-flex align-items-center">
                                                <span class="fs-16 font-weight-semibold dropdown-title">Dai
                                                    Jiang</span>
                                                <span class="font-weight-semibold tiny text-gray-600 ms-auto">Just
                                                    now</span>
                                            </div>
                                            <span class="d-block small text-gray-600 mt-1 dropdown-content">What
                                                about some coffee this afternoon to discuss?</span>
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="dropdown-item text-wrap">
                                    <div class="media">
                                        <span class="d-flex align-items-center">
                                            ...
                                            <span
                                                class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img
                                                    src="https://fabrx.co/preview/muse-dashboard/assets/svg/icons/facebook3.svg"
                                                    alt="Facebook"></span>
                                        </span>
                                        <div class="media-body ps-1">
                                            <div class="d-flex align-items-center">
                                            ...
                                            <span class="d-block small text-gray-600 mt-1 dropdown-content">I
                                                finally got the present I mentioned to Steven, you’ll love
                                                it</span>
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="dropdown-item text-wrap">
                                    <div class="media">
                                        <span class="d-flex align-items-center">
                                            ...
                                            <span
                                                class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img
                                                    src="cfx/assets/img/avatar-sm2.png" alt="Facebook"><span
                                                    class="avatar-status avatar-sm-status avatar-success">&nbsp;</span></span>
                                        </span>
                                        <div class="media-body ps-1">
                                            <div class="d-flex align-items-center">
                                                <span class="fs-16 font-weight-semibold dropdown-title">Trashae
                                                    Hubbard</span>
                                                <span class="font-weight-semibold tiny text-gray-600 ms-auto">Just
                                                    now</span>
                                            </div>
                    ...
                    <div class="dropdown profile-dropdown">
                        <a href="#" class="avatar avatar-sm avatar-circle ms-4 ms-xxl-5" data-bs-toggle="dropdown"
                            ...
                            <img class="avatar-img" src="cfx/assets/img/avatar1.png" alt="Avatar">
                            <span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                            <li class="pt-2 px-4">
                                <span class="fs-16 font-weight-bold text-black-600 Montserrat-font me-2">Bruce
                                    Lee</span><img
                            ...
                            <li>
                                <a class="dropdown-item" href="#"><svg data-name="Icons/Tabler/Share"
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="navbar-collapse">
                    <ul class="navbar-nav" id="accordionExample3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="#sidebarSendMoney2" data-bs-toggle="collapse"
                            ...
                            <div class="collapse collapse-box" id="sidebarSendMoney2"
                                data-bs-parent="#accordionExample3">
                                <ul class="nav nav-sm flex-column" id="submenu6">

                                    <li class="nav-item">
                                        <a href="pricing.html" class="nav-link">Local</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="help-center.html" class="nav-link">International</a>
                                    </li>
