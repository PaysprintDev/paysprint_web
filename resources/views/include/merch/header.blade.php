                ...
                <div class="col-md-6">
                    <ul>
                        <li>
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-success " type="button"><i data-feather="bar-chart"></i>
                                        Total
                        ...
                        <li>
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-success " type="button"><i data-feather="bar-chart"></i>
                                        Total
                                        Store Views: {{ isset($data['views']) ? $data['views'] : 0 }}
                                    </button>
                                </div>
                                <div class="col-md-6">
                                    <small>
            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    ...
                    <ul class="notification-dropdown onhover-show-div">
                        <li>
                            <p class="f-w-700 mb-0">Recent 5 Notifications<span
                                    class="pull-right badge badge-primary badge-pill">5</span></p>
                        </li>
                ...
                <li class="onhover-dropdown p-0">
                    ...
                    <a type="button" href="{{ route('logout') }}"
                        ...
                        class="btn btn-primary-light"><i data-feather="log-out"></i> {{ __('Logout') }}</a>
                </li>
