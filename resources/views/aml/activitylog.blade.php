...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-aqua">
        ...
        <a href="{{ route('platform') }}" class="small-box-footer">View details <i
...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-green">
        ...
        <a href="{{ route('customer service') }}" class="small-box-footer">View details <i class="fa fa-arrow-circle-right"></i></a>
    </div>
</div>
...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-black">
        ...
        <a href="{{ route('technology') }}" class="small-box-footer">View details <i
                class="fa fa-arrow-circle-right"></i></a>
    </div>
</div>
