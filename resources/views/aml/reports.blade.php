...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-aqua">
        ...
        <a href="{{ route('Compliance') }}" class="small-box-footer">View details <i
...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-green">
        ...
        <a href="{{ route('Suspicious Transaction') }}" class="small-box-footer">View details <i class="fa fa-arrow-circle-right"></i></a>
    </div>
</div>
