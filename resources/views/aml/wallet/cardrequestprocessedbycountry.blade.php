...
<?php use \App\Http\Controllers\AddCard; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Credit/Debit Processed Withdrawal
      </h1>
      <ol class="breadcrumb">
      <li><a href="{{ route('Admin') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">Credit/Debit Processed Withdrawal</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body table table-responsive">
              ...
              <table class="table table-bordered table-striped" id="example3">
                ...
                <tbody>
                    @if (count($data['cardRequestProceesedbycountry']) > 0)
                    <?php $i = 1;?>
                        @foreach ($data['cardRequestProceesedbycountry'] as $data)
                        <tr>
                            <td>{{ $i++ }}</td>
