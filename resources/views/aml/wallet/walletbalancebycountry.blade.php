...
<?php use \App\Http\Controllers\ClientInfo; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Wallet Balance In {{ Request::get('country') }}
      </h1>
      <ol class="breadcrumb">
      <li><a href="{{ route('Admin') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">Wallet Balance In {{ Request::get('country') }}</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Wallet Balance In {{ Request::get('country') }}</h3>
