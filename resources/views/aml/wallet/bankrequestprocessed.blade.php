...
<?php use \App\Http\Controllers\AddBank; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Wallet to Bank Account Payment
      </h1>
      <ol class="breadcrumb">
      <li><a href="{{ route('Admin') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">Wallet to Bank Account Payment</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Wallet to Bank Account Payment</h3>
            ...
            <div class="box-body table table-responsive">
              ...
              <table class="table table-bordered table-striped" id="example3">
                ...
                <tbody>
                    @if (count($data['bankRequestProcessed']) > 0)
                    <?php $i = 1;?>
                        @foreach ($data['bankRequestProcessed'] as $data)
                        <tr>
                            <td>{{ $i++ }}</td>
