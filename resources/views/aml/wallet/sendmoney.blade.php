        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#sendMoney" data-toggle="tab">Send Money <i class="fas fa-info-circle" style="cursor: pointer;" title="The fund would be auto deposited into the wallet of the receiver and the receiver would get a text message and email notification of the transaction"></i></a></li>
              <li><a href="#searches" data-toggle="tab">Search</a></li>
              <li onclick="location.href='{{ route('create new merchant payment', 'country='.session('country')) }}'"><a href="{{ route('create new merchant payment', 'country='.session('country')) }}" data-toggle="tab">Text/Email-To-Transfer <i class="fas fa-info-circle" style="cursor: pointer;" title="The receiver would get a text message and an email to download PaySprint App to access the money sent"></i></a></li>

              <li onclick="notifyForm('{{ session('email') }}')"><a data-toggle="tab" href="#notifications">Notification @if(isset($data)) <span class="badge badge-danger">{{ $data['newnotification'] }}</span> @else 0 @endif</a></li>
