...
<br /><br />
 ...
 <table>
   <tbody>
     ...
     <tr>
       <td>Amount: </td>
       <td align="center;" style="font-weight: bold;">{{ $maildata->amount }}</td>
     </tr>

     <tr>
       <td>Type of Service: </td>
       <td align="center;" style="font-weight: bold;">{{ $maildata->service }}</td>
     </tr>
     ...
     <tr>
       <td>City: </td>
       <td align="center;" style="font-weight: bold;">{{ $maildata->city }}</td>
     </tr>

     <tr>
       <td>Provice / State: </td>
       <td align="center;" style="font-weight: bold;">{{ $maildata->state }}</td>
     </tr>

     <tr>
       <td>Postal / Zip code: </td>
       <td align="center;" style="font-weight: bold;">{{ $maildata->zipcode }}</td>
     </tr>
