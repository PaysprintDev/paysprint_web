                                                                                                    ...
                                                                                                    <td valign="top"
                                                                                                        ...
                                                                                                        @if ($maildata->generated_link != null)
                                                                                                            <p>a. Click
                                                                                                                ...
                                                                                                                invoice
                                                                                                                <a
                                                                                                                    href="{{ $maildata->generated_link }}">{{ $maildata->generated_link }}</a>
                                                                                                            </p>
                                                                                                            <p>b.
                                                                                                                Confirm
                                                                                                                invoice
