                                              ...
                                              <tbody>
                                                <tr>
                                                  <td valign="top" class="textContent">
                                                    ...
                                                    <br /><b>You have an invoice for payment on PaySprint.</b>
                                                    <br /><br />
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td style="font-weight: bold;">
                                                            {{ $maildata->payee_ref_no }}</td>
                                                        </tr>

                                                        <tr>
                                                          <td>Customer ID: </td>
                                                          <td style="font-weight: bold;">
                                                            {{ $maildata->customer_id }}</td>
                                                        </tr>
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          <td colspan="2" align="center">
                                                            <h4 style="text-align:center">Here are the details:</h4>
                                                          </td>
                                                        </tr>
