...
<br />There is a new contact message from <b>{{$maildata->email}}. </b> <br><br> Details are stated below:
<br /><br />
...
Website: {{$maildata->website}} <br><br>

Message: {{$maildata->message}} <br><br> 
<br /><br />

<a href="mailto:{{$maildata->email}}">reply {{$maildata->email}}</a><br><br>
