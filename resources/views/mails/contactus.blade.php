                                ...
                                <tr>
                                  ...
                                  -->
                                          <td align="left" valign="middle" id="invisibleIntroduction"
                                            class="flexibleContainerBox" style="display:none !important; mso-hide:all;">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                              style="max-width:100%;">
                                              <tbody>
                                                <tr>
                                          ...
                                          <td align="center" valign="top" class="textContent">
                                            <h1
                                              ...
                                              <img
                                                ...
                                                style="height: 100px"></h1><br>
                                            <h2
                                              style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color: #1ab7dcc9;line-height:135%;font-weight: bold;">
                                              NEW ENQUIRY ON PAYSPRINT</h2>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td valign="top" class="textContent">
                                                    ...
                                                    <br />You have a message from <b>{{$maildata->email}}. </b> <br><br>
                                                    ...
                                                    <hr>
                                                    <p>
                                                      PaySprint is the fastest and affordable method of Sending and
                                                      Receiving money, Paying Invoice and Getting Paid at anytime!
                                                      Download PaySprint App today on <br>
                                                      <ul style="
    display: inline-flex;
    list-style: none;
">

                                                        <li><img id="1617200960035100001_imgsrc_url_1" alt="Play Store"
                                                            style="width :  150px; "
                                                            src="https://res.cloudinary.com/pilstech/image/upload/v1616175829/google-play-soon_miudnn.png">
                                                        </li>

                                                        <li>
                                                          <img id="1617200960035100001_imgsrc_url_2" alt="App Store"
                                                            style="width :  125px; "
                                                            src="https://res.cloudinary.com/pilstech/image/upload/v1616175829/Coming_Soon_to_the_App_Store_izz7ir.png">
                                                        </li>
                                                      </ul> <br>
                                                      Visit our website, <a
